...
const FlxDigitiM = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_20.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Arteria ulnar superficial; nervios digitales ulnares \n\nManiobra de activación y/o nota ecográfica: Flexión MCP 5.º dedo; (US opcional)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_20.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>FLEXOR DIGITI MINIMI</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Flexor corto del meñique</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base falange proximal 5.º dedo<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión MCP 5.º dedo/Colabora en oposición<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈35,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈80–120<strong></strong>
                        </div>
