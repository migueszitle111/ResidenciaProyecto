...
const RhomboideusMi = () => {
    ...
    const images = [
    {
        original: "/assets/ImgTecnicas/miogImg/base4.png",
        thumbnail: "/assets/ImgTecnicas/miogImg/base4.png",
        layers: [
            "/assets/ImgTecnicas/miogImg/base4.png",
            "/assets/ImgTecnicas/miogImg/ELE_45.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Prono o sedente inclinado \n\nPuntos de referencia palpables: Borde medial de la escápula (segmento a nivel de la espina)' +
                        '\n\nPunto de entrada exacto: 1–2 cm medial al borde medial a nivel de la espina \n\nOrientación y profundidad estimada de aguja: Oblicua anterolateral; 1.5–2.5 cm' + 
                        '\n\nPrecauciones: Arteria dorsal de la escápula; pleura si excesiva profundidad medial \n\nManiobra de activación y/o nota ecográfica: Aproximación de escápulas; (US recomendable en biotipos delgados por proximidad pleural)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_45.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>RHOMBOIDEUS MINOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Romboides menor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. dorsal de la escápula (C4–C5)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis espinosas C7–T1<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Borde medial de la escápula (al nivel de la espina)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Retracción y elevación escapular / Rotación inferior<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo I (≈70%)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈160,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈400–600<strong></strong>
                        </div>
