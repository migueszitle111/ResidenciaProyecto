...
const Serratus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_47.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>SERRATUS ANTERIOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Serrato anterior</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. torácico largo (C5–C7)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Costillas I–VIII/IX<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cara costal del borde medial de la escápula<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Protracción y rotación superior de escápula/Fijación escapular<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~1.0–1.3 millones<strong></strong>
                        </div>
