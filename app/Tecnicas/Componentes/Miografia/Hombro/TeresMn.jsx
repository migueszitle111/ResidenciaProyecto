...
const TeresMn = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_39.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Sedente, brazo en ligera aducción \n\nPuntos de referencia palpables: Borde lateral escapular; fosa infraespinosa inferior' +
                        '\n\nPunto de entrada exacto: 2–3 cm lateral al borde escapular inferior \n\nOrientación y profundidad estimada de aguja: Perpendicular; 1.5–2.5 cm' + 
                        '\n\nPrecauciones: Nervio axilar posterior; vasos circunflejos escapulares \n\nManiobra de activación y/o nota ecográfica: Rotación externa suave; (US útil para diferenciar de infraespinoso)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_39.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>TERES MINOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Redondo menor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. axilar (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Borde lateral de la escápula<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tubérculo mayor (carilla inferior)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Rotación externa / Aducción<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo IIa (≈60%)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈80,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈250–400<strong></strong>
                        </div>
