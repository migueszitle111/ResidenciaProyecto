...
const Frontalisis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_94.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n5) Ventana: medial pie. \n\n6) Riesgo: ramas plantares. \n\n7) Posición del paciente: Decúbito supino, pie relajado en ligera eversión.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_94.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>FRONTALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Frontal</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong> N. facial (VII), rama temporal<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Aponeurosis epicraneal <strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Piel de cejas y frente <strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Elevar cejas / Arrugar frente, gestos sociales<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>~60% I, 30% IIa, 10% IIx<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~0.15 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>Bajo (~100)<strong></strong>
                        </div>
