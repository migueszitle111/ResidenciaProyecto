...
const DeltoideusC = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_36.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nProyección antero‑lateral del hombro ', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>DELTOIDEUS (PARS CLAVICULARIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Deltoides (fibras anteriores)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. axilar (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tercio lateral de la clavícula<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tuberosidad deltoidea del húmero<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión y rotación interna del hombro; asistencia a abducción desde posición neutra<strong></strong>
                        </div>
