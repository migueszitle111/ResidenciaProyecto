...
const DigitorumPrU = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_21.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Antebrazo medio‑distal, porción anteromedial, profundo al FDS y FCU \n\nOblicua proximal‑distal atravesando FDS' +
                  '\n\nUS: localizar arteria ulnar entre FCU/FDS distal; mantener plano seguro \n\n≈7–9 cm distal al epicóndilo medial; 1 cm radial al borde cubital' + 
                  '\n\nProyección anteromedial del antebrazo distal ', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_21.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-12">
                            <strong>FLEXOR DIGITORUM PROFUNDUS (ULNARIS PART, TO DIGITS IV–V)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-20">
                            <strong>Flexor profundo de los dedos (dedos 4–5, porción ulnar)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-21">
                            <strong>Inervación:</strong>N. ulnar (ramo al FDP), C8–T1<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cara anterior y medial del cúbito y membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base de falanges distales de dedos 4.º–5.º<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión de IPD de 4.º–5.º; ayuda en flexión de muñeca<strong></strong>
                        </div>
