    ...
    <div>
      ...
      <Accordion title='CERVICAL'>
        ...
        <table>
            ...
            <td>
                <input type='checkbox' id='A9' checked={checkedState.A9} onChange={handleCheckboxChange}></input>
                {checkedState.A9 && ( <img src='/assets/Simbolos/S_Cruz 1.png' className="cruz9"/> )}
              </td>
              <td>
