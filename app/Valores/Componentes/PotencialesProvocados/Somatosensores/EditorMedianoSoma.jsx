//EditorMedianoSoma.js

import { useState } from "react";

const EditorMedianoSoma = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full">
      <div className="w-full md:max-w-screen-lg">
        ...
        <embed src="/assets/NeuronoImg/NERVIO_MEDIANO.pdf" type="application/pdf" width="100%" height="600px" />
...
export default EditorMedianoSoma;
