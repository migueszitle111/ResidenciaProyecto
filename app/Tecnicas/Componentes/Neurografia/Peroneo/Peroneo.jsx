...
const Peroneo = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                {currentImageIndex === 0 && <button className="btnPr1" onClick={() => handleButtonClick('Ligeramente distal a articulación metacarpofalángica, evitando colocar electrodo sobre el pliegue cutáneo.', {  top: '12%', left: '32%' })}>A</button>}
                {currentImageIndex === 0 && <button className="btnPr2" onClick={() => handleButtonClick('Dorso de la mano.', { top: '12%', left: '32%'})}>T</button>}
            </div>
            {textBoxVisible && (
