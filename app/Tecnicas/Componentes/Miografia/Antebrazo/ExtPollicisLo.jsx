...
const ExtPollicisLo = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_25.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Antebrazo en pronación, pulgar relajado \n\n**Puntos de referencia palpables:** Tabaquera anatómica (tendón EPL ulnar a EPB/APL)' +
                        ...
                        '\n\n**Precauciones:** Arteria radial en tabaquera; nervio interóseo posterior \n\n**Maniobra de activación y/o nota ecográfica:** Extensión IP pulgar; (US recomendable en tabaquera para evitar arteria radial)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_25.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>EXTENSOR POLLICIS LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Extensor largo del pulgar</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. interóseo posterior (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ulna distal, membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Falange distal del pulgar<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión interfalángica del pulgar / Extensión MCP y CMC del pulgar<strong></strong>
                        </div>
