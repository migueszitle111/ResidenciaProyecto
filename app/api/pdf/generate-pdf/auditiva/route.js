...
// AU_BASE_TR.png natural size: 1583×2048 px → ratio h/w ≈ 1.2939
  ...
  try {
    ...
    return new NextResponse(pdfBytes, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename=reporte_auditiva.pdf',
      },
    });
  } catch (err) {
    console.error('Error generando PDF auditiva:', err);
