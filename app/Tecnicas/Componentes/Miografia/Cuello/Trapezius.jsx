...
const Trapezius = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_53.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Ramas del plexo cervical superficial; vasos transversos del cuello \n\nManiobra de activación y/o nota ecográfica: Elevación del hombro contra resistencia; (US no suele ser necesaria)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_53.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>TRAPEZIUS (PARS DESCENDENS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Trapecio (porción descendente)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. accesorio (XI) + ramos C3–C4<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Línea nucal superior y lig. nucal<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Clavícula lateral y acromion<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Elevación escapular - extensión cervical asistida / Inclinación contralateral leve<strong></strong>
                        </div>
                        <div className="info-box info-box-10">
                            <strong>Tipo de fibras: </strong>Mixto; predominio tipo I en tono postural, con fibras tipo II para elevación rápida<strong></strong>
                        </div>
                        <div className="info-box info-box-11">
                            <strong>Cantidad de fibras: </strong>Unidades motoras de tamaño medio; reclutamiento escalonado para control escapular fino; actividad tónica postural continua<strong></strong>
                        </div>
