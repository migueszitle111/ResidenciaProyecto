...
const AddLongus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_90.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Supino, cadera ligera abducción \n\n**Puntos de referencia palpables:** Rama púbica; masa medial' +
                        '\n\n**Punto de entrada exacto:** Tercio medio medial, 2 cm posterior a vena safena magna \n\n**Orientación y profundidad estimada de aguja:** Oblicua posterolateral; 2–3 cm' + 
                        '\n\n**Precauciones:** Paquete femoral medial; n. obturador profundo \n\n**Maniobra de activación y/o nota ecográfica:** Aducción contra resistencia; (US recomendable)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_90.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ADDUCTOR LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Aductor largo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. obturador (L2–L4)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Pubis<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Línea áspera (tercio medio)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción de cadera / Flexión ligera; RI/RE según ángulo<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.8–1.1 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈900–1,300<strong></strong>
                        </div>
