...
const GluteusMi = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_79.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Vasos glúteos superiores; n. glúteo superior \n\nManiobra de activación y/o nota ecográfica: Abducción/RI; (US muy recomendada)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>GLUTEUS MINIMUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Glúteo menor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. glúteo superior (L4–S1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ilion entre líneas anterior e inferior<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Trocánter mayor (anterior)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción y RI / Estabilización pélvica<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.5–0.7 millones<strong></strong>
                        </div>
