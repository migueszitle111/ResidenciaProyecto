...
const ExtPollicisBr = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_24.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Arteria radial lateral; nervio interóseo posterior \n\nManiobra de activación y/o nota ecográfica: Extensión MCP pulgar; (US útil para diferenciar de APL)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_24.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>EXTENSOR POLLICIS BREVIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Extensor corto del pulgar</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. interóseo posterior (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Radio distal y membrana interósea<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión MCP pulgar/Colabora en abducción radial<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈200–300<strong></strong>
                        </div>
