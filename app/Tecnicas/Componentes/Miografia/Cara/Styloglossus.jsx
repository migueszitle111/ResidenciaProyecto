...
const Styloglossus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_98.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('1) IZ: región posterolateral profunda. \n\n2) Profundidad: 2–3 cm.' +
                        '\n\n3) Relación: cercano al paquete carotídeo. \n\n4) Variaciones: trayecto divergente.' + 
                        '\n\n5) Ventana segura: submandibular alta. \n\n6) Riesgos: vasos faciales/linguales. \n\n7) Posición: supino cabeza rotada contralateral.', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-1">
                            <strong>STYLOGLOSSUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Estilogloso</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio hipogloso (XII)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis estiloides<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cara lateral de la lengua<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Retracción lengua / Elevación lateral<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈55% tipo I<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈90,000–150,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈180–350 UM<strong></strong>
                        </div>
