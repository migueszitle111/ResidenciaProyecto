...
const ExtIndicis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_23.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                      ...
                      '\n\n**Precauciones:** Arteria interósea posterior profunda; nervio interóseo posterior \n\n**Maniobra de activación y/o nota ecográfica:** Extensión aislada del índice; (US útil para diferenciar de ED)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_23.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>EXTENSOR INDICIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Extensor del índice</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. interóseo posterior (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ulna distal y membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Expansión extensora del 2.º dedo<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión del índice / Extensión de muñeca (secundaria)<strong></strong>
                        </div>
