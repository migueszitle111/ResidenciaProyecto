...
const Brachialis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_40.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Sedente, codo 90°, antebrazo en pronación (para minimizar bíceps) \n\nPuntos de referencia palpables: Borde lateral del bíceps; surco intermuscular lateral' +
                        ...
                        '\n\nPrecauciones: Arteria braquial medial; nervio radial lateral profundo; protección ósea humeral anterior \n\nManiobra de activación y/o nota ecográfica: Flexión del codo isométrica en pronación; (US muy recomendada para ver plano profundo bajo bíceps)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_40.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>BRACHIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Braquial anterior</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. musculocutáneo (C5–C6) ± rama al n. radial (C7)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Mitad distal de la cara anterior del húmero<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Apófisis coronoides y tuberosidad de la ulna<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión pura del codo (todas las posiciones de prono/supi) / Estabilidad articular<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈500–800<strong></strong>
                        </div>
