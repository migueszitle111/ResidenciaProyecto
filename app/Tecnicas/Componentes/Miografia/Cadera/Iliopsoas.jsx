...
const Iliopsoas = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_83.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino con cadera ligeramente flexionada y RE \n\nPuntos de referencia palpables: EIAS; ligamento inguinal; fosa ilíaca' +
                        '\n\nPunto de entrada exacto: 2–3 cm medial a EIAS, 1–2 cm inferior al ligamento inguinal \n\nOrientación y profundidad estimada de aguja: Oblicua posteromedial profunda; 4–6 cm' + 
                        '\n\nPrecauciones: Paquete femoral medial; peritoneo/vísceras \n\nManiobra de activación y/o nota ecográfica: Flexión de cadera contra resistencia; (US altamente recomendada)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_83.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ILIOPSOAS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Ilíaco</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Ramos lumbares (L1–L3); Ilíaco: n. femoral (L2–L3)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong> Psoas: cuerpos T12–L5 → trocánter menor<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Ilíaco: fosa ilíaca → trocánter menor<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión potente de cadera / Estabilización lumbar y pélvica<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Leve predominio I (≈55% I, 40% IIa, 5% IIx)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.6–0.9 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈700–1,100<strong></strong>
                        </div>
