                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Ángulo mandibular (superficie externa)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Elevar mandíbula / Protrusión ligera mandibular<strong></strong>
                        </div>
