    ...
    return (
        ...
        <div>
            ...
            {/* Segunda Imagen */}
                ...
                {currentImageIndex === 1 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Nervio-Mediano.png",{ top: '2%', left: '2%' })}></button>}
            {/* Tercera Imagen */}
                ...
                {currentImageIndex === 2 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Nervio-Mediano-3.png",{ top: '2%', left: '2%' })}></button>}
            {/* Cuarta Imagen */}
                ...
                {currentImageIndex === 3 && <button className="btn24" onClick={() => handleButtonClick('Texto desde el boton 9', { top: '65%', left: '24%' })}></button>}
                ...
                {currentImageIndex === 3 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Mapeo-Sensorial.png",{ top: '2%', left: '2%' })}></button>}
            {/* Quinta Imagen */}
                ...
                {currentImageIndex === 4 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Thumbdiff.png",{ top: '2%', left: '2%' })}></button>}
            {/* Sexta Imagen */}
                ...
                {currentImageIndex === 5 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Ringdiff.png",{ top: '2%', left: '2%' })}></button>}
            {/* Septima Imagen */}
                ...
                {currentImageIndex === 6 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Indice-Sensorial.png",{ top: '2%', left: '2%' })}></button>}
                {currentImageIndex === 6 && <button className="btnI2" onClick={() => handleImageBoxClick("/assets/ValoresImg/Indice-Sensorial-T.png",{ top: '2%', left: '2%' })}></button>}
            {/* Octava Imagen */}
                ...
                {currentImageIndex === 7 && <button className="btnI1" onClick={() => handleImageBoxClick("/assets/ValoresImg/Rastreo-Sensitivo.png",{ top: '2%', left: '2%' })}></button>}
                {currentImageIndex === 7 && <button className="btnI2" onClick={() => handleImageBoxClick("/assets/ValoresImg/Rastreo-T.png",{ top: '2%', left: '2%' })}></button>}
            </div>
            {textBoxVisible && (
