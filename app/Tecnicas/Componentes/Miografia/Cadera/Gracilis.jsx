...
const Gracilis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_93.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Supino \n\n**Puntos de referencia palpables:** Borde medial del muslo; tendón a pata de ganso' +
                        '\n\n**Punto de entrada exacto:** Mitad del muslo medial, 1–2 cm posterior a safena magna \n\n**Orientación y profundidad estimada de aguja:** Perpendicular; 1.5–2.5 cm' + 
                        '\n\n**Precauciones:** Vena safena magna; ramas cutáneas \n\n**Maniobra de activación y/o nota ecográfica:** Aducción con rodilla semiflexa; (US opcional)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_93.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>GRACILIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Recto interno (Grácil)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. obturador (L2–L3)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Rama inferior pubis<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Pata de ganso<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción / Flexión de rodilla y RI<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio I (≈65% I, 30% IIa, 5% IIx)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.3–0.5 millones<strong></strong>
                        </div>
