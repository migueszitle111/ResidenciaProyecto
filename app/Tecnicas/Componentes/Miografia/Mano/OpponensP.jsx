...
const OpponensP = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_03.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            '\n\nPrecauciones: Nervio digital palmar radial; arteria radial superficial \n\nManiobra de activación y/o nota ecográfica: Oposición pulgar-meñique; (US útil en fascículos profundos)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_03.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>OPPONENS POLLICIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Oponente del pulgar</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. mediano (C8–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Trapecio y retináculo flexor<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Borde lateral 1.º metacarpiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Oposición del pulgar (flexión, abducción, rotación)/Estabilización CMC pulgar<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈100–150<strong></strong>
                        </div>
