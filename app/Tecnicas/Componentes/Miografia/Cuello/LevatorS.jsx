...
const LevatorS = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_46.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio accesorio variable superficial; arteria transversa del cuello \n\nManiobra de activación y/o nota ecográfica: Elevación escapular contra resistencia; (US útil para diferenciar de esplenios)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_46.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>LEVATOR SCAPULAE</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Elevador de la escápula</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. dorsal de la escápula (C5) ± ramos C3–C4<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tubérculos posteriores C1–C4<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Ángulo superomedial de la escápula<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Elevar escápula - inclinación ipsilateral/Rotación ipsilateral leve<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo I (≈60%)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈180,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈500–700<strong></strong>
                        </div>
