      ...
      <body>
        ...
        <div class="container">
          ...
          <div class="image-stack">
            ...
            ${
              showBulbar
                ? `<img src="assets/UnionMuscularIMG/UN_Bulbar.png" alt="Bulbar" />`
                : ""
            }
            ${
              showPresinaptico
                ? `<img src="assets/UnionMuscularIMG/UN_Presinaptico.png" alt="Presináptico" />`
                : ""
            }
            ${
              showPostsinaptico
                ? `<img src="assets/UnionMuscularIMG/UN_Postsinaptico.png" alt="Postsináptico" />`
                : ""
            }
            ${
              showDistal
                ? `<img src="assets/UnionMuscularIMG/UN_Distal.png" alt="Distal" />`
                : ""
            }
            ${
              showProximal
                ? `<img src="assets/UnionMuscularIMG/UN_Proximal.png" alt="Proximal" />`
                : ""
            }
          </div>
