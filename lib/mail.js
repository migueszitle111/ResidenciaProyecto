  ...
  <div style="font-family: sans-serif; background: #f5f5f5; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: white; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 30px; color: #333;">
        <p>¡Hola!</p>
        <p>Para crear su contraseña y activar el acceso, haga clic en el siguiente botón:</p>
        ...
        <p>Si el botón no funciona, haga clic en el siguiente enlace:</p>
...
export async function sendWelcomeEmail(email) {
  ...
  <div style="font-family: sans-serif; background: #f5f5f5; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: white; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 30px; color: #333;">
        <p>¡Hola!</p>
        <p>Su suscripción está activa y puede comenzar a disfrutar de nuestros servicios.</p>
        <p style="text-align: center; margin: 30px 0;">
...
export async function sendTrialInfoEmail(email, { trialEndsAt }) {
  ...
  <div style="font-family: sans-serif; background: #f5f5f5; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: white; border-radius: 8px;">
      ...
      <div style="padding: 30px; color: #333;">
        <p>¡Hola!</p>
        <p>Has iniciado una <strong>prueba gratuita de 30 días</strong>. Tu acceso estará activo hasta el <strong>${formattedDate}</strong>.</p>
        <p>Al finalizar, podrás continuar con la suscripción y se procesará el cobro a tu tarjeta registrada.</p>
        <p>Si tienes dudas, contáctanos a <a href="mailto:soporte@medxproapp.com" style="color:#0066cc;">soporte@medxproapp.com</a>.</p>
      </div>
      <div style="background: #fafafa; padding: 15px; text-align: center; font-size: 12px; color: #777;">
        © ${new Date().getFullYear()} MedxProapp. Todos los derechos reservados.
      </div>
  ...
  await safeSendMail({
    from:    `"Soporte MedxProapp" <${process.env.SMTP_USER}>`,
    to:      email,
    subject: "Tienes una prueba gratuita de 30 días en MedxProapp",
    html,
  });
}
