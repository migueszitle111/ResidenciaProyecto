...
const BicBrachiiLon = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_41.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio musculocutáneo en el vientre; arteria braquial medial profunda \n\nManiobra de activación y/o nota ecográfica: Supinación contra resistencia; (US útil para diferenciar fibras largas/cortas y evitar arteria braquial)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_41.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>BICEPS BRACHII (CAPUT LONGUM)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Bíceps braquial (cabeza larga)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. musculocutáneo (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tubérculo supraglenoideo (y labrum)<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tuberosidad del radio y aponeurosis bicipital<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Supinación del antebrazo / Flexión del codo y asistencia en flexión del hombro<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo IIa (≈55%)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈260,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈600–900<strong></strong>
                        </div>
