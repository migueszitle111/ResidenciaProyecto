...
export function checkDivs(copyConclusions) {
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '22.6%', left: '61.9%', borderRadius: '50%', }}
          className={`dont-print-Nervius`} ><NerviusButton value='car' title='DEL TERCIO MEDIAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '25.8%', left: '63.8%', borderRadius: 100, }}
          className={`dont-print-Nervius`}  ><NerviusButton value='car' title='DEL TERCIO DISTAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '30.2%', left: '65.8%', borderRadius: '50%' }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='DEL TERCIO PROXIMAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '35.3%', left: '67.9%', borderRadius: '50%', }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='DEL TERCIO DISTAL DE ANTEBRAZO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('AXILA IZQUIERDO, FOCALIZADA A NIVEL') || copyConclusions.includes('AXILA BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {// FALTA VERIFICAR
    return (
      <>
  ...
  if (copyConclusions.includes('AXILA DERECHO, FOCALIZADA A NIVEL') || copyConclusions.includes('AXILA BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {// FALTA 
    return (
      <>
  ...
  if (copyConclusions.includes('MUSCULOCUTÁNEO IZQUIERDO, FOCALIZADA A NIVEL') || copyConclusions.includes('MUSCULOCUTÁNEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.7%', left: '61.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='DE AXILA,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '40.4%', left: '26.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL DORSO DE LA MANO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('SUPRAESCAPULAR IZQUIERDO, FOCALIZADA A NIVEL') || copyConclusions.includes('SUPRAESCAPULAR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '16.2%', left: '55.2%', borderRadius: 100, }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='LIGAMENTO TRANSVERSO, RAMA SUPRAESPINOSO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('ULNAR DERECHO, FOCALIZADA A NIVEL') || copyConclusions.includes('ULNAR BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.8%', left: '38.8%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL TERCIO PROXIMAL DEL BARZO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '23.6%', left: '37.1%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='DEL TERCIO MEDIAL DEL BRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '42.5%', left: '30.6%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='DE DEDOS IV-V,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('FRÉNICO IZQUIERDO, FOCALIZADA A NIVEL') || copyConclusions.includes('FRÉNICO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '18.6%', left: '52.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL TORAX,' displayText=' ' /> </div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '20.4%', left: '42.3%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TORACICO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('CIATICO DERECHO, FOCALIZADA A NIVEL') || copyConclusions.includes('CIATICO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '35.3%', left: '46.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DE LA ESCOTADURA MAYOR DE LA PELVIS,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '36.4%', left: '43.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL PLIEGUE GLUTEO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '41.2%', left: '42.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO DEL TERCIO PROXIMAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '45.1%', left: '41.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO DEL TERCIO MEDIO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '48.3%', left: '42.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO DEL TERCIO DISTAL,' displayText=' ' /> </div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '35.2%', left: '46.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL FORAMEN MAYOR,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '35.8%', left: '42.6%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL PIRIFORME,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '37.5%', left: '42.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL TERCIO PROXIMAL DEL MUSLO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('GLUTEO SUPERIOR IZQUIERDO, FOCALIZADA A NIVEL') || copyConclusions.includes('GLUTEO MEDIO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {// FALTA VERIFICAR
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '35.0%', left: '55.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL GRLUTEO MAYOR,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('FEMORAL DERECHO, FOCALIZADA A NIVEL') || copyConclusions.includes('FEMORAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '33.0%', left: '44.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='PROXIMAL AL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '36.8%', left: '41.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '39.4%', left: '39.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEBAJO DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '54.2%', left: '44.9%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DE RODILLA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '58.2%', left: '43.5%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '61.4%', left: '43.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL TERCIO MEDIO DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '64.6%', left: '43.0%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL TERCIO DISTAL DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '70.2%', left: '41.0%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='DEL DORSO DEL PIE,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('PERONEO DERECHO, FOCALIZADA A NIVEL') || copyConclusions.includes('PERONEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '54.8%', left: '40.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DE CABEZA DE PERONE,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '58.0%', left: '39.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL TERCIO PROXIMAL DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '60.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL TERCIO MEDIO DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '64.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DEL TERCIO DISTAL DE PIERNA,' displayText=' ' /> </div>
