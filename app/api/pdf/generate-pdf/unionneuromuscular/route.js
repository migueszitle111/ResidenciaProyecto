...
const OVERLAYS_UN = {
  ...
  'Presinaptico':  '/UnionNeuromuscularImg/UN_Presinaptico.png',
  'Postsinaptico': '/UnionNeuromuscularImg/UN_Postsinaptico.png',
};
  ...
  try {
    ...
    return new NextResponse(pdfBytes, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename=reporte_unionneuromuscular.pdf',
      },
    });
  } catch (err) {
    console.error('Error generando PDF union neuromuscular:', err);
