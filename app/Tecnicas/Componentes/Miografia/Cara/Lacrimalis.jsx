                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Supino \n\n**Puntos de referencia palpables:** Canto medial; saco lagrimal' +
                        '\n\n**Punto de entrada exacto:** 0.5 cm lateral al canto medial (subcutáneo) \n\n**Orientación y profundidad estimada de aguja:** Muy superficial; 0.3–0.5 cm' + 
                        '\n\n**Precauciones:** Saco lagrimal; vasos angulares \n\n**Maniobra de activación:** Parpadeo suave con foco en canto medial', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>ORBICULARIS OCULI (PARS LACRIMALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Orbicular de los ojos (lagrimal)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. facial (VII)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cresta lagrimal posterior<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tarso medial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Bombeo lagrimal / Ayuda a cierre medial<strong></strong>
                        </div>
