...
export function checkDivsBILATERAL(copyConclusions) {
  console.log('Valor de copyConclusions:', copyConclusions);

  if (copyConclusions.includes('AXILAR BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    console.log('Mostrando botones del primer conjunto');
    return (
      <>
        <div
          style={{ position: 'absolute', top: '18.9%', left: '58.8%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="INMEDIATO A SU EMERGENCIA,"
            displayText=" "
            onClick={() => handleButtonClick('INMEDIATO A SU EMERGENCIA,')}
          />
        </div>
        <div
          style={{ position: 'absolute', top: '19.1%', left: '60.2%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="DEL ESPACIO CUANDRANGULAR,"
            displayText=" "
            onClick={() => handleButtonClick('DEL ESPACIO CUANDRANGULAR,')}
          />
        </div>
        <div
          style={{ position: 'absolute', top: '19.3%', left: '61.5%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="MEDIAL AL CUELLO QUIRÚRGICO DEL HÚMERO,"
            displayText=" "
            onClick={() => handleButtonClick('MEDIAL AL CUELLO QUIRÚRGICO DEL HÚMERO,')}
          />
        </div>
      </>
    );
  ...
  // Segunda etapa
  if (/AXILAR BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL.*/.test(copyConclusions)) {
    console.log('Mostrando botones del segundo conjunto');
    return (
      <>
        <p>Seleccionaste: {selectedTitle}</p>
        <div
          style={{ position: 'absolute', top: '18.9%', left: '39.8%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="INMEDIATO A SU EMERGENCIA,"
            displayText=" "
            onClick={() => console.log('Seleccionaste INMEDIATO A SU EMERGENCIA,')}
          />
        </div>
        <div
          style={{ position: 'absolute', top: '19.1%', left: '38.5%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="DEL ESPACIO CUANDRANGULAR,"
            displayText=" "
            onClick={() => console.log('Seleccionaste DEL ESPACIO CUANDRANGULAR,')}
          />
        </div>
        <div
          style={{ position: 'absolute', top: '19.3%', left: '37.2%', borderRadius: 100 }}
          className="dont-print-Nerviusgrande"
        >
          <NerviusButtonBILATERAL
            value="car"
            title="MEDIAL AL CUELLO QUIRÚRGICO DEL HÚMERO,"
            displayText=" "
            onClick={() => console.log('Seleccionaste MEDIAL AL CUELLO QUIRÚRGICO DEL HÚMERO,')}
          />
        </div>
      </>
    );
  ...
  /*
  if ( copyConclusions.includes('MEDIANO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (
      <>
        <div style={{ position: 'absolute', top: '17.6%', left: '50.5%', borderRadius: '50%' }}
          className={`.dont-print-Nerviusgrande`}> <NerviusButtonBILATERAL value='car' title='INMEDIATO A SU EMERGENCIA,' displayText=' ' /> </div>
        ...
        <div style={{ position: 'absolute', top: '14.4%', left: '50.2%', borderRadius: '50%' }}
          className={`.dont-print-Nerviusgrande`}> <NerviusButtonBILATERAL value='car' title='SUPRACLAVICULAR,' displayText=' ' /> </div>
        ...
        <div style={{ position: 'absolute', top: '19.5%', left: '58.9%', borderRadius: '50%' }}
          className={`.dont-print-Nerviusgrande`}> <NerviusButtonBILATERAL value='car' title='DE AXILA,' displayText=' ' />  </div>
        ...
        <div style={{ position: 'absolute', top: '22.6%', left: '61.9%', borderRadius: '50%', }}
          className={`dont-print-Nervius`} ><NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '25.8%', left: '63.8%', borderRadius: 100, }}
          className={`dont-print-Nervius`}  ><NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '27.9%', left: '64.8%', borderRadius: 100, }}
          className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='LIGAMENTO STRUTHERS,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '29.4%', left: '65.5%', borderRadius: '50%' }}
          className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DEL CODO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '30.2%', left: '65.8%', borderRadius: '50%' }}
          className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '31.7%', left: '66.6%', borderRadius: '50%', }}
          className={`dont-print-Nervius`} ><NerviusButtonBILATERAL value='car' title='PRONADOR REDONDO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '33.1%', left: '67.1%', borderRadius: '50%', }}
          className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '36.0%', left: '68.2%', }}
          className={`dont-print-Nervius`} ><NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '38.3%', left: '69.3%', }}
          className={`dont-print-Nervius`} ><NerviusButtonBILATERAL value='car' title='DEL CARPO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '40.3%', left: '71.5%', }}
          className={`dont-print-Nervius`}> <NerviusButtonBILATERAL value='car' title='DE PALMA,' displayText=' ' /> </div>
        <div style={{ position: 'absolute', top: '41.1%', left: '71.8%', }}
          className={`dont-print-Nervius`}> <NerviusButtonBILATERAL value='car' title='DE PALMA,' displayText=' ' /> </div>
        <div style={{ position: 'absolute', top: '41.9%', left: '72.1%', }}
          className={`dont-print-Nervius`}> <NerviusButtonBILATERAL value='car' title='DE DEDOS II-III,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('MEDIANO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (
      <>
    ...
    return (
      <>
        <div style={{ position: 'absolute', top: '32.4%', left: '32.5%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIO DEL ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '35.4%', left: '30.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DEL ANTEBRAZO,' displayText=' ' /></div>
    ...
    return (
      <>
        <div style={{ position: 'absolute', top: '14.5%', left: '51.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TRIANGULO POSTERIOR DEL CUELLO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '14.0%', left: '50.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL FORAMEN YUGULAR,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('AXILARO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {// FALTA VERIFICAR
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '19.1%', left: '60.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL ESPACIO CUANDRANGULAR,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '19.3%', left: '61.5%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='MEDIAL AL CUELLO QUIRURGICO DEL HUMERO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '18.3%', left: '62.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DE SU DIVICION TERMINAL,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('AXILARO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {// FALTA 
    return (
      <>
  ...
  if ( copyConclusions.includes('MUSCULOCUTÁNEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '17.1%', left: '55.3%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='INFRACLAVICULAR,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '20.0%', left: '60.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='INFRACLAVICULAR,' displayText=' ' /></div>
      <div style={{ position: 'absolute', top: '20.7%', left: '61.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DE AXILA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '30.2%', left: '67.8%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DEL ANTEBRAZO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '32.6%', left: '68.6%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIO DEL ANTEBRAZO,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('RADIAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      <div style={{ position: 'absolute', top: '14.5%', left: '48.0%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='SUPRACLAVICULAR,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '16.5%', left: '43.0%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='INMEDIATO A SU EMERGENCIA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '32.3%', left: '30.3%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DEL ANTEBRAZO,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '38.9%', left: '26.9%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL CARPO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '40.4%', left: '26.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL DORSO DE LA MANO,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '40.6%', left: '29.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DE PALMA,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('SUPRAESCAPULAR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '16.2%', left: '55.2%', borderRadius: 100, }}
        className={`dont-print-Nervius`}><NerviusButtonBILATERAL value='car' title='DE LA ESCOTADURA ESCAPULAR/LTS,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '17.1%', left: '57.4%', borderRadius: 100, }}
        className={`dont-print-Nervius`}> <NerviusButtonBILATERAL value='car' title='DE LA ESCOTADURA ESPINOGLENOIDEA/LTS,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '18.5%', left: '56.2%', borderRadius: 100, }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DE LA FOSA INFRAESCAPULAR,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('ULNAR BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.8%', left: '38.8%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DEL BARZO,' displayText=' ' /></div>

      <div style={{ position: 'absolute', top: '21.5%', left: '38.4%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DEL BRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '23.6%', left: '37.1%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIAL DEL BRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '28.3%', left: '35.0%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DEL CODO/CANAL CUBITAL,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '36.2%', left: '32.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DEL ANTEBRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '38.7%', left: '30.7%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DEL CARPO/CANAL DE GUYON,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '42.5%', left: '30.6%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButtonBILATERAL value='car' title='DE DEDOS IV-V,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('ULNAR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.8%', left: '59.9%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DEL BRAZO,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('FRÉNICO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '14.8%', left: '50.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL PLEXO CERVICAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '18.6%', left: '52.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TORAX,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '22.6%', left: '52.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL DIAFRAGMA,' displayText=' ' /> </div>
    </>);
  }
    ...
    return (
      <>
        <div style={{ position: 'absolute', top: '18.0%', left: '43.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='INMEDIATO A SU EMERGENCIA DE AXILA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '20.4%', left: '42.3%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='TORACICO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('CIATICO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '34.5%', left: '44.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DE LA ESCOTADURA MAYOR DE LA PELVIS,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '37.2%', left: '43.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='EMERGENCIA PIRAMIDAL,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '38.0%', left: '43.0%', }}
        className={`.dont-print-Nerviusgrande`}  > <NerviusButtonBILATERAL value='car' title='EMERGENCIA PIRAMIDAL,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '38.8%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`}  > <NerviusButtonBILATERAL value='car' title='DEL PLIEGUE GLUTEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '39.6%', left: '42.6%', }}
        className={`.dont-print-Nerviusgrande`}  > <NerviusButtonBILATERAL value='car' title='DEL PLIEGUE GLUTEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '40.4%', left: '42.4%', }}
        className={`.dont-print-Nerviusgrande`}  > <NerviusButtonBILATERAL value='car' title='DEL MUSLO TERCIO PROXIMAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '48.3%', left: '42.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL MUSLO TERCIO DISTAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '54.0%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL HUECO POPLIEO,' displayText=' ' /> </div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '34.8%', left: '45.1%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL FORAMEN MAYOR,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '36.2%', left: '44.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL PIRIFORME,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '35.3%', left: '56.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='ATRAVES DEL PIRIFORME,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '35.7%', left: '57.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='SU RAMA TERMINAL,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('FEMORAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '34.4%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='ARRIBA DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '36.0%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='ARRIBA DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '36.8%', left: '41.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '37.6%', left: '41.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '38.4%', left: '41.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEBAJO DEL LIGAMENTO INGUINAL,' displayText=' ' /> </div>
    ...
    return (
      <>
        <div style={{ position: 'absolute', top: '53.4%', left: '45.1%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DEL MUSLO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '54.2%', left: '44.9%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DE RODILLA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '58.2%', left: '43.5%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '61.4%', left: '43.7%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIO DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '64.6%', left: '43.0%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DE LA PIERNA,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '68.6%', left: '41.8%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL TOBILLO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '70.2%', left: '41.0%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL DORSO DEL PIE,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '72.6%', left: '39.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButtonBILATERAL value='car' title='DEL ANTEPIE,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('OBTURADOR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      <div style={{ position: 'absolute', top: '31.6%', left: '55.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='PROXIMAL A CANAL OBTURADOR,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '38.7%', left: '56.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='CANAL OBTURADOR,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '41.0%', left: '56.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='MUSLO,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('PERONEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '52.4%', left: '41.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL HUECO POPLITEO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '55.6%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DE CABEZA DE PERONE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '56.4%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DE CABEZA DE PERONE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '57.2%', left: '39.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DE CUELLO DE PERONE,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '58.0%', left: '39.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO PROXIMAL DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '60.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO MEDIO DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '64.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TERCIO DISTAL DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '71.6%', left: '40.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='PIE,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('TIBIAL BILATERAL CON PREDOMINIODERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '71.7%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL TARSO,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('SURAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '71.2%', left: '38.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL RETROPIE,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('PUDENDO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '36.1%', left: '48.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL FORAMEN CIATICO,' displayText=' ' /> </div>
  ...
  if ( copyConclusions.includes('FACIAL BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL')) {
    return (<>
      <div style={{ position: 'absolute', top: '5.2%', left: '52.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='RAMA TEMPOROFACIAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '8.5%', left: '50.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='INTRAPETROSO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '8.6%', left: '54.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DEL FORAMEN ESTILOMASTOIDEO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '10.6%', left: '53.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='RAMA CERVICOFACIAL,' displayText=' ' /></div>
  ...
  if ( copyConclusions.includes('FACIAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL')) {
    return (<>
      <div style={{ position: 'absolute', top: '5.2%', left: '46.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButtonBILATERAL value='car' title='DE RAMA TEMPOROFACIAL,' displayText=' ' /> </div>
