...
const SimpleMultiStepForm = ({ showStepNumber }) => {
  ...
  return (
    <div>
      ...
      {step === 'F' && <StepF handlePrevStep={handlePrevStep} handleNextStep={handleNextStep} setStep={setStep}  handlePrint={handlePrint}/>}
...
const StepA = ({ handleNextStep ,setStep}) => (
  <div>
    ...
    <div onClick={() => setStep('D')}>
      <ConclusionButton value="indenme" title="VÍA TRIGEMINO FACIAL INDEMNE CON INTEGRIDAD FUNCIONAL " displayText="INDEMNE" />    </div>
    <div onClick={() => setStep('B')}>
      <ConclusionButton value="alterada" title="VÍA TRIGEMINO FACIAL VISUAL ALTERADA CON DEFECTO FUNCIONAL " displayText="ALTERADA " />
    </div>
  </div>
);
...
const StepE = ({ handleNextStep, handlePrevStep, setStep }) => (
  <div>
    ...
    <div onClick={() => setStep('F')}>
      <ConclusionButton value='aferente_ipsilateral' title='TOPOGRÁFICAMENTE A NIVEL AFERENTE IPSILATERAL ' displayText='AFERENTE IPSILATERAL' />
      <ConclusionButton value='integracion_pontina' title='TOPOGRÁFICAMENTE A NIVEL INTEGRACIÓN PONTINA ' displayText='INTEGRACIÓN PONTINA' />
      <ConclusionButton value='nucleo_y_formacion_reticular' title='TOPOGRÁFICAMENTE A NIVEL NUCLEO Y FORMACIÓN RETICULAR' displayText='NUCLEO Y FORMACIÓN RETICULAR' />
      <ConclusionButton value='referente' title='TOPOGRÁFICAMENTE A NIVEL EFERENTE  ' displayText='REFERENTE' />
    </div>
  </div>
);


const StepF = ({ setStep, selectedImages, handleUndo, handleImageChange, handlePrint }) => (
  <div>
    <div className='button-bar'>
