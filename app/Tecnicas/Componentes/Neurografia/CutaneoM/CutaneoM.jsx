...
const CutaneoM = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                {currentImageIndex === 0 && <button className="btnCM1" onClick={() => handleButtonClick('CODO. Punto medio trazado entre el borde medial del tendón del bíceps braquial y epicóndilo medial, 1-2 cm proximal del pliegue del codo.', {  top: '12%', left: '32%' }, 'E')}></button>}
