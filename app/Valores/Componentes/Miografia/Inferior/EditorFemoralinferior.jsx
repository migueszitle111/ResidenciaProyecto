//EditorFemoralInferior.js

import { useState } from "react";

const EditorFemoralInferior = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full">
      <div className="w-full md:max-w-screen-lg">
        <h1 className="text-lg text-left text-white font-bold mb-2">Femoral</h1>
...
export default EditorFemoralInferior;
