...
const DigitorumPrR = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_07.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Tercio medio del antebrazo, cara anterior medial al FDS; 6–8 cm distal al epicóndilo medial \n\nOrientación oblicua proximodistal, atravesando FDS hacia FDP' +
            '\n\nUS: identificar FDS superficial deslizándose sobre FDP; arteria ulnar más medial distal — evitarla \n\n≈6–8 cm distal al epicóndilo medial; 1–2 cm medial a la línea media' + 
            '\n\nProyección anteromedial del antebrazo medio ', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_07.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-12">
                            <strong>FLEXOR DIGITORUM PROFUNDUS (RADIALIS PART, TO DIGITS II–III)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-20">
                            <strong>Flexor profundo de los dedos (dedos 2–3, porción radial)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-21">
                            <strong>Inervación:</strong>N. interóseo anterior (mediano), C8–T1<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cara anterior y medial del cúbito (proximal 3/4) y membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base de falanges distales de dedos 2.º–3.º<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión de las IPD de 2.º–3.º; contribuye a flexión de PIP, MCP y muñeca<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo I (≈65%)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>400 000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>800-1200<strong></strong>
                        </div>
