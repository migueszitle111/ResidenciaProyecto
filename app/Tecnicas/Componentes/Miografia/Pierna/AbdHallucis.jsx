...
const AbdHallucis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_66.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('1) IZ: borde medial navicular. \n\n2) Profundidad: 0.5–1 cm.' +
                        '\n\n3) Relación: superficial. \n\n4) Variación: vientre doble ocasional.' + 
                        '\n\n5) Ventana: medial pie. \n\n6) Riesgo: ramas plantares. \n\n7) Posición del paciente: Decúbito supino, pie relajado en ligera eversión.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_66.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ABDUCTOR HALLUCIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Aductor del hallux</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio plantar medial<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tuber calcáneo medial<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base falange proximal hallux<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción hallux / Soporte arco medial<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈55% I, 45% II<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈150–300 UM<strong></strong>
                        </div>
