    ...
    return (
        ...
        <div>
            ...
            {/* Tercera Imagen */}
                ...
                {currentImageIndex === 2 && <button className="btn12" onClick={() => handleButtonClick('CODO. Fosa antecubital, solo medial al pulso de la arteria braquial', { top: '57%', left: '48%' })}></button>}
            ...
            {/* Quinta Imagen */}
                ...
                {currentImageIndex === 4 && <button className="btn27" onClick={() => handleButtonClick('NERVIO MEDIANO - (antidrómica) entre tendones de los palmares mayor/menor a 10 cm en dirección proximal del electrodo de registro', { top: '65%', left: '24%' })}></button>}
                {currentImageIndex === 4 && <button className="btn28" onClick={() => handleButtonClick('NERVIO RADIAL - (antidromica) borde lateral del radio a 10 cm en dirección proximal del electrodo de registro', { top: '65%', left: '24%' })}></button>}
                {currentImageIndex === 4 && <button className="btn29" onClick={() => handleButtonClick('DEDO PULGAR (THUMBDIFF) - Diferencia de latencia sensorial MEDIANO-RADIAL con registro en el primer dedo', { top: '55%', left: '74%' })}></button>}
                {currentImageIndex === 4 && <button className="btn30" onClick={() => handleButtonClick('ACTIVO, ligeramente distal a la articulación metacarpofalángica REFERENCIA, 3-4 cm distal', { top: '55%', left: '74%' })}></button>}
            ...
            {/* Sexta Imagen */}
                ...
                {currentImageIndex === 5 && <button className="btn32" onClick={() => handleButtonClick('NERVIO CUBITAL - (antidromica) A través de la muñeca 14 cm proximal del electrodo activo, medial al tendón cubital anterior', { top: '59%', left: '24%' })}></button>}
                {currentImageIndex === 5 && <button className="btn33" onClick={() => handleButtonClick('NERVIO MEDIANO - (antidromica) A través de la muñeca 14 cm proximal del electrodo activo, entre los tendones de los palmares mayor/menor', { top: '59%', left: '24%' })}></button>}
                {currentImageIndex === 5 && <button className="btn34" onClick={() => handleButtonClick('DEDO ANULAR (RINGDIFF) - Diferencia de latencia sensorial MEDIANO-CUBITAL con registro en el IV dedo', { top: '65%', left: '24%' })}></button>}
                {currentImageIndex === 5 && <button className="btn35" onClick={() => handleButtonClick('ACTIVO, ligeramente distal a la articulación metacarpofalángica REFERENCIA, 3-4 cm distal', { top: '65%', left: '24%' })}></button>}
            ...
            {/* Septima Imagen */}
                ...
                {currentImageIndex === 6 && <button className="btn39" onClick={() => handleButtonClick('ACTIVO, discretamente proximal al pliegue de la muñeca, existiendo una distancia de 8 cm en relación al punto de estimulación, REFERENCIA 3 cm proximal', { top: '65%', left: '24%' })}></button>}
                {currentImageIndex === 6 && <button className="btn40" onClick={() => handleButtonClick('ACTIVO, discretamente proximal al pliegue de la muñeca, existiendo una distancia de 8 cm en relación al punto de estimulación, REFERENCIA 3 cm proximal', { top: '65%', left: '24%' })}></button>}
            ...
            {/* Octava Imagen */}
                ...
                {currentImageIndex === 7 && <button className="btn45" onClick={() => handleButtonClick('DEDO MEDIO O ÍNDICE - Ligeramente distal a la articulación metacarpofalángica, evitando colocar electrodo sobre pliegue cutáneo.', { top: '65%', left: '24%' })}></button>}
