    ...
    <div>
      <div className="Conteiner mx-auto">
        <div>
          ...
          <div
            className="lg:w-2/3 bg-[#bababa]  md:p-10 flex flex-col mx-auto m-5 rounded-tr-lg rounded-bl-lg p-5"
            style={{
              backgroundImage: 'url("/propaganda.png")',
          ...
          >
            <div className="md:w-1/2">
              <div className="flex">
                <Image
                  src="/assets/IconSVG/I_Education.svg"
                  alt="Logo de la empresa"
                  width={55}
                  height={35}
                  className="Cerebro"
                />
                <h2 className="text-4xl text-white">APLICACIÓN</h2>
              </div>
              <p className="text-white m-4">
                La mejor experiencia solo en nuestra app.
              </p>
              ...
              <div className="flex space-x-4 m-3">
                ...
                >
                  ...
                  <div>
                    <div class="text-xs">Proximamente en </div>
