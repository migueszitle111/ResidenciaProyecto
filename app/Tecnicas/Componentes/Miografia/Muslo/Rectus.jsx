...
const Rectus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_86.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Supino, cadera neutra \n\n**Puntos de referencia palpables:** EIAI (profunda) y vientre anterior' +
                        '\n\n**Punto de entrada exacto:** 8–10 cm distal a EIAI en línea media \n\n**Orientación y profundidad estimada de aguja:** Perpendicular; 2–3 cm' + 
                        '\n\n**Precauciones:** Ramas femorales; vasos femorales laterales \n\n**Maniobra de activación y/o nota ecográfica:** Flexión de cadera; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_86.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>RECTUS FEMORIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Recto femoral</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. femoral (L2–L4)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>EIAI<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tendón cuadricipital/tuberosidad tibial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión de cadera / Extensión de rodilla<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio IIa (≈40% I, 55% IIa, 5% IIx)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈1.0–1.4 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1,200–1,800<strong></strong>
                        </div>
