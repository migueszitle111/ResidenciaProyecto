...
const StepA = ({ handleNextStep ,setStep}) => (
  <div>
    ...
    <div onClick={() => setStep('D')}>
      <ConclusionButton value="indenme" title="INDEMNE CON INTEGRIDAD FUNCIONAL " displayText="INDEMNE" />    </div>
    <div onClick={() => setStep('B')}>
      <ConclusionButton value="alterada" title="ALTERADA CON DEFECTO FUNCIONAL " displayText="ALTERADA " />
    </div>
  </div>
);
