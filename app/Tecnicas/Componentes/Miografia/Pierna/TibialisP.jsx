...
const TibialisP = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_62.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Paquete tibial posterior; N. tibial \n\nManiobra de activación y/o nota ecográfica: Inversión resistida; (US altamente recomendada)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_62.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>TIBIALIS POSTERIOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tibial posterior</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. tibial (L4–L5)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Membrana interósea y tibia/fíbula posteriores<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Navicular y expansiones plantares<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Inversión y soporte arco medial / Flexión plantar accesoria<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.35–0.45 millones<strong></strong>
                        </div>
