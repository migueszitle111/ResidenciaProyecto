...
const UlnarMt = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                {currentImageIndex === 0 && <button className="btnUMt1" onClick={() => handleButtonClick('CODO. 2-3 cm distal al epicóndilo medial en línea media dibujada con relación al olecranon.', {  top: '10%', left: '25%' }, 'E')}></button>}
                {currentImageIndex === 0 && <button className="btnUMt2" onClick={() => handleButtonClick('Dorso de la mano  o antebrazo.', {top: '10%', left: '25%'}, 'T')}></button>}
                ...
                {currentImageIndex === 1 && <button className="btnUMt7" onClick={() => handleButtonClick('AXILA. Base del hueco axilar o 1cm distal entre borde lateral de los músculos Pectoral menor y porción corta del Bíceps braquial.', { top: '10%', left: '55%'}, 'E')}></button>}
                {currentImageIndex === 1 && <button className="btnUMt8" onClick={() => handleButtonClick('ARRIBA DE CODO. 10 cm proximal al punto de estimulación de codo, a nivel de humero medial entre tendones de Bíceps-Tríceps.', {  top: '10%', left: '55%' }, 'E')}></button>}
                {currentImageIndex === 1 && <button className="btnUMt9" onClick={() => handleButtonClick('CODO. 2-3 cm distal al epicóndilo medial en línea media dibujada con relación al olecranon.', { top: '10%', left: '55%'}, 'E')}></button>}
                {currentImageIndex === 1 && <button className="btnUMt10" onClick={() => handleButtonClick('Dorso de la mano o antebrazo.', {  top: '10%', left: '55%' }, 'T')}></button>}
                ...
                {currentImageIndex === 2 && <button className="btnUMt16" onClick={() => handleButtonClick('Dorso de la mano.', {  top: '62%', left: '70%' }, 'T')}></button>}
