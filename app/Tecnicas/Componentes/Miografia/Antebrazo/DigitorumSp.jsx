...
const DigitorumSp = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_08.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            '\n\nPrecauciones: Arteria ulnar medial profunda; nervio mediano en arco superficial \n\nManiobra de activación y/o nota ecográfica: Flexión PIP de dedos 2–5; (US recomendable para ubicar vientre profundo)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_08.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>FLEXOR DIGITORUM SUPERFICIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Flexor superficial de los dedos</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. mediano (C7–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Epicóndilo medial, radio proximal y coronoides<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Falanges medias dedos 2–5<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión interfalángica proximal / Flexión de muñeca y codo<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈110,000<strong></strong>
                        </div>
