...
const FlxpollicisBr = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_02.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            '\n\nPrecauciones: Arco palmar superficial; ramas digitales nerviosas \n\nManiobra de activación y/o nota ecográfica: Flexión MCP pulgar; (US opcional para separar fascículos)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_02.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-12">
                            <strong>FLEXOR POLLICIS BREVIS (CAPUT SUPERFICIALE)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-20">
                            <strong>Flexor corto del pulgar (cabeza superficial)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. mediano (C8–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Retináculo flexor y trapecio<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base falange proximal del pulgar<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión MCP pulgar/Colaboración en oposición<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈50,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈120–200<strong></strong>
                        </div>
