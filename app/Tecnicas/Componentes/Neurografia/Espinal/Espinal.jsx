...
const Espinal = () => {
    ...
    return (
        ...
        <div>
            ...
            {currentImageIndex === 0 && <button className="btnEp2" onClick={() => handleButtonClick('TRAPEZIUS C3, C4 - Fibras superiores con electrodo de superficie colocar 5-8 cm lateral en relacion a la apófisis espinosa C7', { top: '12%', left: '32%'})}></button>}
            {currentImageIndex === 0 && <button className="btnEp3" onClick={() => handleButtonClick('3 cm lateral del electrodo de registro ', {  top: '12%', left: '32%' })}></button>}
