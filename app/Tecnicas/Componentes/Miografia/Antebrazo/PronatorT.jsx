...
const PronatorT = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_11.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            '\n\nPrecauciones: Nervio mediano pasa entre sus fascículos; arteria ulnar profunda medial \n\nManiobra de activación y/o nota ecográfica: Pronación contra resistencia; (US muy recomendable para evitar nervio mediano)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_11.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PRONATOR TERES</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pronador redondo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. mediano (C6–C7)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Epicóndilo medial y apófisis coronoides<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Radio (tercio medio, cara lateral)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Pronación del antebrazo / Flexión accesoria del codo<strong></strong>
                        </div>
