            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Perforantes femorales profundas \n\nManiobra de activación y/o nota ecográfica: Aducción isométrica; (US útil)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>ADDUCTOR MAGNUS (PARS ADDUCTORIA)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Aductor mayor (porción aductora)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. obturador (L2–L4)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Rama isquiopúbica<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Línea áspera<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción potente / Flexión/RI según fibras<strong></strong>
                        </div>
