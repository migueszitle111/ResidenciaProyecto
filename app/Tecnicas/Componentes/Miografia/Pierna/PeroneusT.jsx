...
const PeroneusT = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_74.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**1) IZ:** tercio distal lateral. \n\n**2) Profundidad:** 0.8–1.5 cm.' +
                        '\n\n**3) Relación:** adyacente al EDL. \n\n**4) Variaciones:** ausente en ~8%.' + 
                        '\n\n**5) Ventana segura:** lateral distal. \n\n**6) Riesgos:** contacto tibial. \n\n**7) Posición:** supino con dorsiflexión ligera.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_74.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PERONEUS TERTIUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Peroneo Tertius</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio peroneo profundo<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tercio distal del peroné y membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base del quinto metatarsiano (cara dorsal)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Dorsiflexión del pie / Eversión ligera del pie<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈40% tipo I, 60% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈60,000–120,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈120–260 UM<strong></strong>
                        </div>
