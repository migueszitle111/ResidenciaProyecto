...
const Oris = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_96.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Sedente \n\nPuntos de referencia palpables: Comisuras; surco filtrum' +
                        '\n\nPunto de entrada exacto: Cuadrante superolateral del labio, 1 cm lateral a comisura \n\nOrientación y profundidad estimada de aguja: Perpendicular; 0.3–0.5 cm' + 
                        '\n\nPrecauciones: Vasos labiales superior/inferior \n\nManiobra de activación: Cierre labial fuerte o silbido', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_96.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ORBICULARIS ORIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Orbicular de los labios</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong> N. facial (VII), rama bucal<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Músculos periorales<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Piel y mucosa labial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Cierre labial / Fruncimiento/succión/fonación<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>~50% I, 40% IIa, 10% IIx<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~0.2 millones<strong></strong>
                        </div>
