            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Arteria y vena braquial en canal medial; nervio mediano más distal \n\nManiobra de activación y/o nota ecográfica: Flexión del codo contra resistencia; (US recomendada para identificar paquete vasculonervioso medial)', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>Biceps brachii (caput breve)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Bíceps braquial (cabeza corta)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. musculocutáneo (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis coracoides<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión del codo / Supinación; estabilización anterior del hombro<strong></strong>
                        </div>
