...
const TibialPx = () => {
    ...
    const [textBoxClass, setTextBoxClass] = useState('text-boxTbP');
    ...
    return (
        <div className=" py-20 gallery-container">
                        ...
                        {currentImageIndex === 0 && (
                            <button className={`btnOndasTib ${activeBtn === 'btnOndasTb' ? 'active' : ''}`} onClick={() => {
                                        ...
                                        handleMultiImageBoxClick([
                                            ...
                                            "/assets/ImgTecnicas/Potenciales/Somt/TibCanalP3.png",
            ...
            {textBoxVisible && (
                <div
                    className={`text-boxTbP ${textBoxClass}`}
