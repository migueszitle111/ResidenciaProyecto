...
const BicepsFemorisL = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_58.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio ciático; arterias perforantes \n\nManiobra de activación y/o nota ecográfica: Extensión cadera/flexión rodilla; (US recomendable)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_58.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>BICEPS FEMORIS (CAPUT LONGUM)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Bíceps femoral (cabeza larga)</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cabeza del peroné<strong></strong>
                        </div>
