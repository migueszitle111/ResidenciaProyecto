...
const Palpebralis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_95.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Supino, ojos cerrados suavemente \n\n**Puntos de referencia palpables:** Borde palpebral; ligamento palpebral medial' +
                        '\n\n**Punto de entrada exacto:** Tercio lateral del párpado superior, 0.5 cm de la línea de pestañas \n\n**Orientación y profundidad estimada de aguja:** Oblicua muy superficial; 0.3–0.5 cm' + 
                        '\n\n**Precauciones:** Evitar placa tarsal y globo ocular \n\n**Maniobra de activación:** Parpadeo suave repetido', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>ORBICULARIS OCULI (PARS PALPEBRALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Orbicular de los ojos (palpebral)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. facial (VII)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Lig. palpebral medial<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Canto lateral (tabique)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Parpadeo suave / Cierre palpebral reflectivo<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>~55% I, 35% IIa, 10% IIx<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~0.25 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>Bajo<strong></strong>
                        </div>
