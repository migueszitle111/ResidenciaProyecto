...
const ExtDigitorumB = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_75.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**1) IZ:** vientre dorsal \n\n**2) Profundidad:** 0.2–0.6 cm.' +
                        '\n\n**3) Relación:** superficial. \n\n**4) Variaciones:** tamaño variable.' + 
                        '\n\n**5) Ventana segura:** dorsal pie. \n\n**6) Riesgos:** vena marginal. \n\n**7) Posición:** supino pie neutro.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_75.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>EXTENSOR DIGITORUM BREVIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Extensor corto de los dedos</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio peroneo profundo<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Calcáneo dorsa<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tendones extensores de los dedos 2–4<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extiende dedos 2–4 / Estabilidad dorsal pie<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈45% tipo I, 55% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈40,000–90,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈100–200 UM<strong></strong>
                        </div>
