...
const transporter = nodemailer.createTransport({
  ...
  secure:     process.env.SMTP_PORT === "465",    // SSL/TLS inmediato
  requireTLS: process.env.SMTP_PORT === "587",    // fuerza STARTTLS si es 587
  auth: {
...
export async function sendWelcomeEmail(email) {
  await transporter.sendMail({
    ...
    html:    `<p>¡Hola!</p>
              <p>Gracias por unirte a MedxProapp. Tu suscripción está activa y ya puedes disfrutar de todos nuestros servicios.</p>
