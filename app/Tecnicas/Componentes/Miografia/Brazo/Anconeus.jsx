...
const Anconeus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_32.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio interóseo posterior (rama radial) más distal; bursa olecraniana \n\nManiobra de activación y/o nota ecográfica: Extensión suave del codo; (US útil para delimitar vientre pequeño y evitar bursa)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>ANCONEUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Ancóneo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. radial (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Epicóndilo lateral del húmero<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cara lateral del olécranon y ulna proximal<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Asistencia a extensión del codo / Estabilización posterolateral del codo<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈40,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈100–200<strong></strong>
                        </div>
