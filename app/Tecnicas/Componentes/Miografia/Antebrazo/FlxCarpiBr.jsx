...
const FlxCarpiBr = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_10.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 gallery-container">
            ...
            '\n\nPrecauciones: Arteria radial lateral profunda; nervio mediano medial \n\nManiobra de activación y/o nota ecográfica: Flexión radial de muñeca; (US útil para ubicar tendón FCR vs PL)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>FLEXOR CARPI RADIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Flexor radial del carpo</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base 2.º–3.º metacarpiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión y abducción de la muñeca / Flexión accesoria del codo<strong></strong>
                        </div>
