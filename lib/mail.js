...
// Email para restablecer/crear contraseña
  ...
  <div style="font-family: sans-serif; background: #f5f5f5; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: white; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 30px; color: #333;">
        ...
        <p>Tu suscripción ya está activa y puedes comenzar a disfrutar de todos nuestros servicios médicos profesionales.</p>
        <p style="text-align: center; margin: 30px 0;">
