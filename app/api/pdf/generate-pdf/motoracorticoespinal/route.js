  ...
  const overlayRules = [
...

    {
      expectedValue: 'bilaterallumbasacro', 
        ...
        image: [
          {
            src: '/assets/CorticoespinalImg/ViasAfectadas/INFERIOR D.png',
            alt: 'Modelo',
          },
          {
            src: '/assets/CorticoespinalImg/ViasAfectadas/INFERIOR I.png',
            alt: 'Modelo',
          }]
    },
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="image-stack">
        <img src="/assets/MioImg/MO_BASE_BLANCO_MOTORES.png" alt="Imagen Base" />
        ${overlayHtml}
      </div>
