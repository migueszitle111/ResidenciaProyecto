...
const AbdPollicisLo = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_26.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Antebrazo en pronación \n\nPuntos de referencia palpables: Tabaquera anatómica radial' +
                        ...
                        '\n\nPrecauciones: Arteria radial superficial; nervio interóseo posterior \n\nManiobra de activación y/o nota ecográfica: Abducción radial del pulgar; (US muy recomendable en zona compartimental)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_26.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>ABDUCTOR POLLICIS LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Abductor largo del pulgar</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. interóseo posterior (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ulna, radio y membrana interósea (tercio medio)<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base 1.º metacarpiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción radial CMC pulgar/Colabora extensión pulgar<strong></strong>
                        </div>
