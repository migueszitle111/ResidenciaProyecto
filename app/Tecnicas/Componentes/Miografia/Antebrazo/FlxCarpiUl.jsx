...
const FlxCarpiUl = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_22.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                      ...
                      '\n\nPrecauciones: Nervio cubital en surco epitroclear proximal y distalmente; arteria ulnar profunda \n\nManiobra de activación y/o nota ecográfica: Flexión cubital de muñeca; (US útil para guiar y evitar nervio ulnar)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>FLEXOR CARPI ULNARIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Flexor cubital del carpo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. ulnar (C7–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Epicóndilo medial y olécranon<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Pisiforme, ganchoso y 5.º metacarpiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión y aducción de la muñeca / Flexión accesoria del codo<strong></strong>
                        </div>
