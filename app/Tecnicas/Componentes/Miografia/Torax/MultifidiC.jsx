...
const MultifidiC = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_99.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n5) Ventana segura: corte parasagital medial. \n\n6) Riesgos: contacto facetario si dirección excesiva medial. \n\n7) Posición del paciente: Paciente en decúbito prono con ligera flexión cervical; almohadilla bajo el pecho.', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>MULTIFIDI CERVICIS ET ROTATORES</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Paraespinales cervicales</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Ramos dorsales de nervios cervicales<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis articulares C3–C7<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Láminas cervicales 1–3 niveles superiores<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Estabilidad cervical segmentaria / Control fino de rotación-extensión<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈65% tipo I, ≈35% tipo II (alto rol postural)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈250,000–420,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈900–1500 UM<strong></strong>
                        </div>
