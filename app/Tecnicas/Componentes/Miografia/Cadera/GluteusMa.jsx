...
const GluteusMa = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_81.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio ciático profundo; vasos glúteos inferiores \n\nManiobra de activación y/o nota ecográfica: Extensión contra resistencia; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_81.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>GLUTEUS MAXIMUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Glúteo mayor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. glúteo inferior (L5–S2)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ilion posterior, sacro<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tracto IT y tuberosidad glútea<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión potente de cadera / RE y estabilización<strong></strong>
                        </div>
                        <div className="info-box info-box-18">
                            <strong>Tipo de fibras: </strong>Mixto con leve predominio IIa (≈45% I, 50% IIa, 5% IIx)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈1.5–2.0 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1,500–2,500<strong></strong>
                        </div>
