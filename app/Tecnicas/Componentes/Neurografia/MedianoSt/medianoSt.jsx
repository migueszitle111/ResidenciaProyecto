    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                ...
                {currentImageIndex === 0 && <button className="btnIMs2" onClick={() => openModal("/assets/ValoresImg/Mediano-DedoG.png",{ top: '2%', left: '2%' })}></button>}
            {/* Segunda Imagen */}
                ...
                {currentImageIndex === 1 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Nervio-Mediano.png",{ top: '2%', left: '2%' })}></button>}
            {/* Tercera Imagen */}
                ...
                {currentImageIndex === 2 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Nervio-Mediano-3.png",{ top: '2%', left: '2%' })}></button>}
            {/* Cuarta Imagen */}
                ...
                {currentImageIndex === 3 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Mapeo-Sensorial.png",{ top: '2%', left: '2%' })}></button>}
            {/* Quinta Imagen */}
                ...
                {currentImageIndex === 4 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Thumbdiff.png",{ top: '2%', left: '2%' })}></button>}
            {/* Sexta Imagen */}
                ...
                {currentImageIndex === 5 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Ringdiff.png",{ top: '2%', left: '2%' })}></button>}
            {/* Septima Imagen */}
                ...
                {currentImageIndex === 6 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Indice-Sensorial.png",{ top: '2%', left: '2%' })}></button>}
            ...
            {/* Octava Imagen */}
                ...
                {currentImageIndex === 7 && <button className="btn46" onClick={() => handleButtonClick('...', { top: '60%', left: '24%' })}></button>}
                
                {currentImageIndex === 7 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/Rastreo-Sensitivo.png",{ top: '2%', left: '2%' })}></button>}
