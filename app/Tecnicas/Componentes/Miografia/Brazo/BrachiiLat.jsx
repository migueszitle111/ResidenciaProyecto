...
const BrachiiLat = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_33.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio radial en canal espiral (proximal) y en septo lateral (distal) \n\nManiobra de activación y/o nota ecográfica: Extensión del codo contra resistencia; (US útil para evitar trayecto radial distal)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>TRICEPS BRACHII (CAPUT LATERALE)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tríceps braquial (cabeza lateral)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. radial (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cara posterior del húmero por encima del surco radial<strong></strong>
                        </div>
