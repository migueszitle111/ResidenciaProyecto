...
const Brachioradialis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_31.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>BRACHIORADIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Braquiorradial</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. radial (rama al braquiorradial)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cresta supracondílea lateral del húmero<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Apófisis estiloides del radio (cara lateral)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión del codo (máxima en semipronación); estabilización en movimientos rápidos<strong></strong>
                        </div>
...
export default Brachioradialis;
