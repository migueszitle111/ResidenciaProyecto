...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 gallery-container">
            ...
            '\n\nPrecauciones: Nervios digitales medianos; arco palmar superficial \n\nManiobra de activación y/o nota ecográfica: Flexión MCP dedos 2–3; (US recomendable para separar de interóseos)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>Lumbricales manus (I–II)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Lumbricales de la mano (1.º–2.º)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>Inervación: N. mediano (C8–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Origen: Tendones FDP radial (dedos 2–3)<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Expansiones dorsales 2–3<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión MCP y extensión IP dedos 2–3/Control fino pinza<strong></strong>
                        </div>
