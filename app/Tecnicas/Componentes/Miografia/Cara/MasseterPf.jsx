...
const MasseterPf = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_97.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Cercanía a vasos masetéricos; riesgo parotídeo \n\nManiobra de activación: Cierre mandibular sostenido', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>MASSETER (PARS PROFUNDA)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Masetero (superficial)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. trigémino (V3, n. masetérico)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Arco cigomático<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Rama mandibular (superficie interna)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Elevar mandíbula / Estabilización articular<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~1.1 millones<strong></strong>
                        </div>
