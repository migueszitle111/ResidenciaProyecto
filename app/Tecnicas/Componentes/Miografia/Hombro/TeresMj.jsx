...
const TeresMj = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_48.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Vasos circunflejos escapulares; nervio subescapular profundo \n\nManiobra de activación y/o nota ecográfica: Extensión/adducción contra resistencia; (US opcional)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_48.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>TERES MAJOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Redondo mayor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. subescapular inferior (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ángulo inferior de la escápula<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Labio medial del surco bicipital<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Rotación interna, aducción, extensión del hombro/Estabilización humeral<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈100,000<strong></strong>
                        </div>
