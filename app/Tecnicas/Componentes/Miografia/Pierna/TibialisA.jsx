...
const TibialisA = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_71.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n**Precauciones:** A. tibial anterior/N. fibular profundo distales; periostio tibial \n\n**Maniobra de activación y/o nota ecográfica:** Dorsiflexión; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_71.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>TIBIALIS ANTERIOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tibial anterior</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. fibular profundo (L4–L5)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cóndilo lateral tibial y tibia lateral<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base 1.º metatarsiano y cuneiforme medial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Dorsiflexión de tobillo / Inversión del pie<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio fibras I/IIa (≈55% I, 40% IIa, 5% IIx)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈350–500<strong></strong>
                        </div>
