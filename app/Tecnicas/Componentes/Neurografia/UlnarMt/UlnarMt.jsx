    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                ...
                {currentImageIndex === 0 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/01ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                {currentImageIndex === 0 && <button className="btnIMs2" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/01ulnarT.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 1 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/02ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                {currentImageIndex === 1 && <button className="btnIMs2" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/01ulnarT.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 2 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/03ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 3 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/04ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 4 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/05ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 5 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/06ulnarG.png",{ top: '2%', left: '2%' })}></button>}
                ...
                {currentImageIndex === 6 && <button className="btnIMs1" onClick={() => openModal("/assets/ValoresImg/MiembrosSp/07ulnarG.png",{ top: '2%', left: '2%' })}></button>}
