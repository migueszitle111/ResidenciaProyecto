              ...
              {figuras.map(f => (
                <div key={f.id}
                  ...
                  style={{
                    ...
                    width: f.tipo==='symbol'?48:80, height: f.tipo==='symbol'?48:80,
                ...
                >
                  ...
                  <img src={f.src} alt="" draggable={false} style={{
                    width: '100%', height: '100%', objectFit: f.tipo==='symbol'?'contain':'cover',
                    borderRadius: f.tipo === 'circle' ? '50%' : 0,
                    border: f.tipo==='symbol'?'none':'1.5px solid gray',
                    display: 'block',
                    pointerEvents: 'none',
                  }} />
