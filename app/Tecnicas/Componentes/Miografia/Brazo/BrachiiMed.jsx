...
const BrachiiMed = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_35.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n**Precauciones:** Nervio ulnar (más medial en surco epitroclear distal); arteria braquial profunda proximal \n\n**Maniobra de activación y/o nota ecográfica:** Extensión isométrica; (US recomendable para visualizar ulnar distalmente)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_35.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>TRICEPS BRACHII (CAPUT MEDIALE)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tríceps braquial (cabeza medial)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. radial (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cara posterior del húmero por debajo del surco radial<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Olecranon<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión del codo / Estabilización del codo<strong></strong>
                        </div>
