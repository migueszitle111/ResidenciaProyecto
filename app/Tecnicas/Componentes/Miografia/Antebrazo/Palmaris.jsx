...
const Palmaris = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_09.png", // segunda imagen encima
        ]
    },
];
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Antebrazo supinado, codo extendido \n\n**Puntos de referencia palpables:** Tendón visible al oponer pulgar-meñique' +
                ...
                '\n\n**Precauciones:** Arteria mediana accesoria (variable); nervio mediano profundo \n\n**Maniobra de activación y/o nota ecográfica:** Flexión de muñeca ligera; (US opcional; músculo ausente en ~15% población)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_09.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PALMARIS LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Palmar largo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. mediano (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Epicóndilo medial<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Aponeurosis palmar<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión de la muñeca / Tensar aponeurosis palmar<strong></strong>
                        </div>
