...
const Latissimus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_49.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**Posición del paciente:** Prono o sedente \n\n**Puntos de referencia palpables:** Borde posterolateral del tronco; ángulo inferior de la escápula como referencia' +
                        '\n\n**Punto de entrada exacto:** 4–5 cm inferior y medial al ángulo inferior escapular (vientre lateral) \n\n**Orientación y profundidad estimada de aguja:** Perpendicular; 2–3 cm' + 
                        '\n\n**Precauciones:** Vasos toracodorsales; pleura posterolateral profunda \n\n**Maniobra de activación y/o nota ecográfica:** Extensión/adducción contra resistencia; (US útil para diferenciar de serrato/oblicuos)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_49.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>LATISSIMUS DORSI</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Dorsal ancho</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. toracodorsal (C6–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis espinosas T7–L5, fascia TL, cresta ilíaca, costillas inferiores<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Surco bicipital (húmero)<strong></strong>
                        </div>
                        <div className="info-box info-box-23">
                            <strong>Función: </strong>Extensión - adducción - RI del hombro / Depresión - estabilización escapular vía cadena cinética<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>~45–55% I; 35–45% IIa; ≤10% IIx<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~1.8–2.1 millones<strong></strong>
                        </div>
