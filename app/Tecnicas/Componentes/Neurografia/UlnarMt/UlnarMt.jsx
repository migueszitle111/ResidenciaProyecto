    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                ...
                {currentImageIndex === 0 && <button className="btnUMt2" onClick={() => handleButtonClick('Dorso de la mano', {top: '10%', left: '25%'})}></button>}
                ...
                {currentImageIndex === 5 && <button className="btnUMt30" onClick={() => handleButtonClick('1', { top: '10%', left: '25%'})}></button>}
                {currentImageIndex === 5 && <button className="btnUMt31" onClick={() => handleButtonClick('2', {  top: '10%', left: '25%' })}></button>}
                {currentImageIndex === 5 && <button className="btnUMt32" onClick={() => handleButtonClick('3', { top: '10%', left: '25%'})}></button>}
                {currentImageIndex === 5 && <button className="btnUMt33" onClick={() => handleButtonClick('3', { top: '10%', left: '25%'})}></button>}
