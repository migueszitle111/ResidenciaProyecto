...
const MultifidiL = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_101.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-12">
                            <strong>MULTIFIDI LUMBORUM ET SACRUM</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Paraespinales lumbosacros</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Ramos dorsales L1–S1<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Sacro, EIPS, procesos mamilares L1–L5<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Espinosas lumbares<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Estabilidad lumbar y control segmentario / Extensión lumbar fina<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈70% tipo I (muy postural)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈450,000–900,000<strong></strong>
                        </div>
