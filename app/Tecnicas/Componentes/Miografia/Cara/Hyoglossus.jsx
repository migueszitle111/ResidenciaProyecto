                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**1) IZ:** borde lateral profundo. \n\n**2) Profundidad:** 1.2–2 cm.' +
                        '\n\n**3) Relación:** cercano al paquete lingual. \n\n**4) Variaciones:** volumen variable.' + 
                        '\n\n**5) Ventana segura:** submandibular. \n\n**6) Riesgos:** vasos linguales. \n\n**7) Posición:** supino cuello extendido.', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-1">
                            <strong>HYOGLOSSUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Hiogloso</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio hipogloso (XII).<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Hioides.<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Dorsum lengua + hioides.<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Depresión lengua / Retracción parcial.<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈60% tipo I<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈100,000–150,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈200–450 UM<strong></strong>
                        </div>
