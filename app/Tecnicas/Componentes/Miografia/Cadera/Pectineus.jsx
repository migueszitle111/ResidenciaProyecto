...
const Pectineus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_84.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick("...", { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-1">
                            <strong>PECTINEUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pectíneo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. femoral (L2–L3) ± obturador<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cuerpos Pecten pubis<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Línea pectínea<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción y flexión / RI ligera<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio I (≈60% I, 35% IIa, 5% IIx)<strong></strong>
                        </div>
