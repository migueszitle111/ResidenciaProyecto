...
const DeltoideusS = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_38.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nProyección posterolateral del hombro', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>DELTOIDEUS (PARS SPINALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Deltoides (fibras posteriores)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. axilar (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Espina de la escápula (borde inferior)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión y rotación externa del hombro<strong></strong>
                        </div>
