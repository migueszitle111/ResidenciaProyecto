                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Prono o sedente inclinado \n\nPuntos de referencia palpables: Borde medial de la escápula (porción inferior)' +
                        '\n\nPunto de entrada exacto: 2–3 cm medial al borde medial inferior a la espina \n\nOrientación y profundidad estimada de aguja: Oblicua anterolateral; 2–3 cm' + 
                        '\n\nPrecauciones: Arteria dorsal de la escápula; pleura torácica profunda \n\nManiobra de activación y/o nota ecográfica: Aproximación de escápulas; (US recomendable para ver distancia a pleura)', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>RHOMBOIDEUS MAJOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Romboides mayor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. dorsal de la escápula (C4–C5)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis espinosas T2–T5<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Borde medial de la escápula (por debajo de la espina)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈220,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈600–800<strong></strong>
                        </div>
