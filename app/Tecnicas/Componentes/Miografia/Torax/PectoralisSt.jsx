                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-12">
                            <strong>PECTORALIS MAJOR (PARS STERNOCOSTALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pectoral mayor (porción esternocostal)</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Esternón y cartílagos costales II–VI<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción y rotación interna / Descenso de cintura escapular, inspiración accesoria<strong></strong>
                        </div>
