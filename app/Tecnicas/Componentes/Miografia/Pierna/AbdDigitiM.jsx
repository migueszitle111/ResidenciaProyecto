...
const AbdDigitiM = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_69.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino/prono \n\nPuntos de referencia palpables: Borde lateral plantar' +
                        ...
                        '\n\nPrecauciones: N. sural/N. plantar lateral; A. plantar lateral \n\nManiobra de activación y/o nota ecográfica: Abducción 5.º; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/ELE_69_Z2.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>ABDUCTOR DIGITI MINIMI PEDIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Abductor del meñique del pie</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. plantar lateral (S2–S3)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Proceso lateral calcáneo<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Base falange proximal 5.º<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción 5.º dedo / Soporte lateral arco<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio IIa<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈220–320<strong></strong>
                        </div>
