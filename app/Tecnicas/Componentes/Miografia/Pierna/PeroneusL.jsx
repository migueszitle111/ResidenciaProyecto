...
const PeroneusL = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_76.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('1) IZ: tercio proximal lateral. \n\n2) Profundidad: 1–2 cm.' +
                        '\n\n3) Relación: superficial al brevis. \n\n4) Variaciones: longitud variable.' + 
                        '\n\n5) Ventana segura: lateral pierna. \n\n6) Riesgos: ramas cutáneas. \n\n7) Posición: decúbito lateral contralateral.', { top: "8%", left: "23%" });
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_76.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PERONEUS LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Peroneo Longus</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio peroneo superficial<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cabeza del peroné y 2/3 proximales laterales<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cuneiforme medial y primer metatarsiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Eversión del pie / Soporte del arco transverso<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈48% tipo I, 52% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈250,000–350,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈350–700 UM<strong></strong>
                        </div>
