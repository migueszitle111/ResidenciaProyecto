...
const Semitendinosus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_56.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio ciático (lateral); vena safena parva distal \n\nManiobra de activación y/o nota ecográfica: Extensión/flexión; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_56.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>SEMITENDINOSUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Semitendinoso</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de cadera / Flexión de rodilla y RI<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.8–1.0 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈900–1,200<strong></strong>
                        </div>
