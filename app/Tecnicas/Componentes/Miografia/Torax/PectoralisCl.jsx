...
const PectoralisCl = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_50.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino o sedente, brazo en ligera abducción (20–30°) \n\nPuntos de referencia palpables: Borde inferior de clavícula; esternón; surco deltopectoral' +
                        ...
                        '\n\nPrecauciones: Vasos toracoacromiales; evitar punción muy medial por cercanía de pleura \n\nManiobra de activación y/o nota ecográfica: Aducción horizontal contra resistencia; (US útil para delimitar grosor y evitar pleura en biotipos delgados)', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-12">
                            <strong>PECTORALIS MAJOR (PARS CLAVICULARIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pectoral mayor (porción clavicular)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. pectoral lateral (C5–C6) ± pectoral medial (C7–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Mitad medial de la clavícula<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cresta del tubérculo mayor<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión y aducción del hombro/Rotación interna, aproximación horizontal<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~1.8–2.2 millones<strong></strong>
                        </div>
