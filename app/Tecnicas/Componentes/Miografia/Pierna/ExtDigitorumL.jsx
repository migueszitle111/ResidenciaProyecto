...
const ExtDigitorumL = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_72.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: A./N. tibial anterior \n\nManiobra de activación y/o nota ecográfica: Extensión dedos; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_72.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>EXTENSOR DIGITORUM LONGUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Extensor largo de los dedos</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. fibular profundo (L5–S1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cóndilo lat. tibial, fíbula, membrana interósea<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Expansiones dorsales 2–5<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de dedos 2–5 / Dorsiflexión tobillo y ligera eversión<strong></strong>
                        </div>
