...
// BP_NTR.png: 1582×2048
const LAM_IMG_RATIO = 2048 / 1582;

const OVERLAY_MAP_NEURO = {
  ...
  try {
    ...
    return new NextResponse(pdfBytes, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename=reporte_neuronopatia.pdf',
      },
    });
  } catch (err) {
    console.error('Error generando PDF neuronopatia:', err);
