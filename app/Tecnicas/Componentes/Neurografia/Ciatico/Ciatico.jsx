...
const Ciatico = () => {
    ...
    return (
        ...
        <div>
            ...
            {currentImageIndex === 0 && <button className="btnCt4" onClick={() => handleButtonClick('HUECO POPLÍTEO. Con estimulador convencional de puntas, se realiza la estimulación respectiva de nervio Peroneo siguiendo el trayecto a nivel lateral.', { top: '62%', left: '50%' })}></button>}
