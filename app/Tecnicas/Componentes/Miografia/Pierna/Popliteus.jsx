...
const Popliteus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_65.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n5) Ventana: corte transversal. \n\n6) Riesgo: arteria poplítea medial. \n\n7) Posición del paciente: Decúbito prono, rodilla flexionada 10–20° para relajar gastrocnemio.', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>POPLITEUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Poplíteo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio tibial<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Cóndilo femoral lateral<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cara posterior tibial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Desbloqueo de rodilla / Rotación interna tibial<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈120,000–250,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈250–450 UM<strong></strong>
                        </div>
