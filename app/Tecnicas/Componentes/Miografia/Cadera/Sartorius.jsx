...
const Sartorius = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_85.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino, cadera en ligera abducción/RE \n\nPuntos de referencia palpables: EIAS; trayecto oblicuo a pata de ganso' +
                        '\n\nPunto de entrada exacto: Tercio proximal del muslo, 2 cm distal a EIAS (borde anteromedial) \n\nOrientación y profundidad estimada de aguja: Oblicua caudolateral; 2–3 cm' + 
                        '\n\nPrecauciones: Ramas cutáneas femorales; vena safena magna distal \n\nManiobra de activación y/o nota ecográfica: Posición de sastre; (US opcional)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_85.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>SARTORIUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Sartorio</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. femoral (L2–L3)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>EIAS<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Pata de ganso (tibia anteromedial)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión, abducción y RE de cadera / Flexión de rodilla<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Mixto (≈50% I, 45% IIa, 5% IIx)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.35–0.5 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈400–700<strong></strong>
                        </div>
