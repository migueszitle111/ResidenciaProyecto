...
const AddBrevis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_91.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino \n\nPuntos de referencia palpables: Rama púbica; profundo a aductor largo' +
                        '\n\nPunto de entrada exacto: 2–3 cm distal/medial a tubérculo púbico \n\nOrientación y profundidad estimada de aguja: Oblicua posterolateral; 3–4 cm' + 
                        '\n\nPrecauciones: Vasos obturatrices; n. obturador \n\nManiobra de activación y/o nota ecográfica: Aducción suave; (US muy recomendada)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_91.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ADDUCTOR BREVIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Aductor corto</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. obturador (L2–L3)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Línea Pubis<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Línea pectínea/áspera proximal<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Aducción / Flexión ligera<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio I/IIa<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.6–0.8 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈700–1,000<strong></strong>
                        </div>
