...
const BrachiiLon = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_34.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n**Precauciones:** Nervio radial en canal de torsión (más distal/lateral); arteria braquial profunda \n\n**Maniobra de activación y/o nota ecográfica:** Extensión del codo contra resistencia; (US opcional para ubicar septos entre cabezas)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_34.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>TRICEPS BRACHII (CAPUT LONGUM)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tríceps braquial (cabeza larga)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. radial (C7–C8)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tubérculo infraglenoideo<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Olecranon ulnae<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión del codo / Extensión-adducción del hombro (secundaria)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈360,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈800–1,200<strong></strong>
                        </div>
