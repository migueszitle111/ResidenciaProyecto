            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n5) Ventana segura: submentoniana. \n\n6) Riesgos: vasos linguales. \n\n7) Posición: supino con ligera extensión cervical.', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>GENIOGLOSSUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Geniogloso</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio hipogloso (XII)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Espinas mentonianas<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Protrusión lengua / Apertura vía aérea<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈70% tipo I<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈150,000–250,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈300–600 UM<strong></strong>
                        </div>
