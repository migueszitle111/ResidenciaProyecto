...
const CutaneoFemoral = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
            {currentImageIndex === 0 && <button className="btnCf1" onClick={() => handleButtonClick('INGUINAL. 4 cm debajo del ligamento inguinal, lateral a la arteria femoral con presión firme.', { top: '10%', left: '23%' }, 'E')}></button>}
