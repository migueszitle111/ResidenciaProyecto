...
const Diaphragma = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_55.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>DIAPHRAGMA</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Diafragma</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-17">
                            <strong>Inervación: </strong>Nervio frénico C3–C5 (principalmente C4)<strong></strong>
                        </div>
                        <div className="info-box info-box-14">
                            <strong> Origen: </strong>Pilares derecho e izquierdo (L1–L3), arcos costales, cartílagos costales 7–12, esternón (apéndice xifoides)<strong></strong>
                        </div>
                        <div className="info-box info-box-15">
                            <strong>Inserción: </strong>Centro tendinoso diafragmático<strong></strong>
                        </div>
                        <div className="info-box info-box-16">
                            <strong>Función: </strong>Aumenta el diámetro vertical del tórax / Contribución a maniobras de Valsalva y estabilización del tronco<strong></strong>
                        </div>
                        <div className="info-box info-box-10">
                            <strong>Tipo de fibras: </strong>Predominio tipo I (resistencia), con IIa para demandas fásicas<strong></strong>
                        </div>
                        {/* <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>---<strong></strong>
                        </div> */}
