...
const Tibial = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
            {currentImageIndex === 0 && <button className="btnTb1" onClick={() => handleButtonClick('HUECO POPLITEO. Ligeramente lateral del punto medio sobre el pliegue cutáneo poplíteo.', { top: '62%', left: '23%' }, 'E')}></button>}
            {currentImageIndex === 0 && <button className="btnTb2" onClick={() => handleButtonClick('TOBILLO. Ligeramente detrás del maléolo medial, línea media entre el borde óseo y el tendón de Aquiles, aproximadamente 8-10 cm del electrodo activo.', { top: '62%', left: '23%' }, 'E')}></button>}
            ...
            {currentImageIndex === 2 && <button className="btnTb13" onClick={() => handleButtonClick('Dorso del pie.', { top: '62%', left: '23%' }, 'T')}></button>}
            ...
            {currentImageIndex === 3 && <button className="btnTb19" onClick={() => handleButtonClick('GASTROCNEMIUS LATERAL S1, S2 - 8 a 10 cm distal del pliegue de la rodilla con orientación lateral, tomando como referencia una línea horizontal desde los tendones isquiotibiales en el hueco poplíteo.', { top: '62%', left: '23%' }, 'A')}></button>}
            {currentImageIndex === 3 && <button className="btnTb20" onClick={() => handleButtonClick('Distal al recorrido del tendón de Aquiles.', { top: '62%', left: '23%' }, 'R')}></button>}
            {currentImageIndex === 3 && <button className="btnTb21" onClick={() => handleButtonClick('Justo debajo del borde inferior del gastrocnemio con orientación lateral.', { top: '62%', left: '23%' }, 'R')}></button>}
