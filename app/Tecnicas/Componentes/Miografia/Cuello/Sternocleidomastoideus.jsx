...
const Sternocleidomastoideus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_52.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Vena yugular interna profunda; paquete carotídeo medial; nervio accesorio dentro del vientre \n\nManiobra de activación y/o nota ecográfica: Rotar cabeza contralateral contra resistencia; (US útil si variantes o vasos prominentes)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_52.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>STERNOCLEIDOMASTOIDEUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Esternocleidomastoideo</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. accesorio (XI) + ramos C2–C3<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Manubrio esternal y tercio medial clavícula<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Proceso mastoides y línea nucal<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Rotación contralateral de cabeza / Inclinación ipsilateral - flexión cervical<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>~1 millón<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>Alto (~1000)<strong></strong>
                        </div>
...
export default Sternocleidomastoideus;
