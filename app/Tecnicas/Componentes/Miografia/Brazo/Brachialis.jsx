            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Arteria braquial medial; nervio radial lateral profundo; protección ósea humeral anterior \n\nManiobra de activación y/o nota ecográfica: Flexión del codo isométrica en pronación; (US muy recomendada para ver plano profundo bajo bíceps)', { top: "8%", left: "23%" });
