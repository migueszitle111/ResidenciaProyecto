...
const PectoralisM = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_51.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Supino, brazo en ligera abducción y rotación externa \n\nPuntos de referencia palpables: Proceso coracoides; espacios intercostales 3–5' +
                        ...
                        '\n\nPrecauciones: Pleura y arteria toracoacromial; plexo braquial superolateral \n\nManiobra de activación y/o nota ecográfica: Protracción escapular (‘empuje’); (US recomendable por pleura subyacente)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_51.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PECTORALIS MINOR</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pectoral menor</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. pectoral medial (C8–T1) ± pectoral lateral (C5–C7)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Costillas III–V<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Proceso coracoides<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Basculación anterior y descenso de escápula / Inspiración accesoria<strong></strong>
                        </div>
