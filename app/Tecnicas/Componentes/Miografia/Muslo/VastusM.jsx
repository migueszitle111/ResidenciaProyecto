...
const VastusM = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_89.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('1) IZ: región oblicua distal. \n\n2) Profundidad: 0.8–2 cm.' +
                        '\n\n3) Relación: medial a RF. \n\n4) Variaciones: IZ más distal en deportistas.' + 
                        '\n\n5) Ventana segura: corte medial. \n\n6) Riesgos: ramas geniculadas. \n\n7) Posición del paciente: Decúbito supino, rodilla semiflexionada 30°, rotación externa suave.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_89.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>VASTUS MEDIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Vasto medial</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio femoral<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Línea intertrocantérica y línea áspera medial<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de rodilla / Estabilidad patelar medial<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈52% tipo I, 48% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈900,000–1,200,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈450–850 UM<strong></strong>
                        </div>
