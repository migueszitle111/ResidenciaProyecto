...
const Semimembranosus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_57.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\n**Precauciones:** Nervio ciático lateral; vasos perforantes \n\n**Maniobra de activación y/o nota ecográfica:** Flexión/RI; (US muy recomendada)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_57.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>SEMIMEMBRANOSUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Semimembranoso</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. tibial (L5–S2)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tuberosidad isquiática<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cóndilo medial tibial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de cadera / Flexión rodilla y RI<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.9–1.1 millones<strong></strong>
                        </div>
...
export default Semimembranosus;
