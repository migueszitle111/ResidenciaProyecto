            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnCap2" onClick={() => openModal("/assets/ImgTecnicas/Potenciales/Visual/Camp-T01.png")}></button>
                        ...
                        ></button>*/}
                        <button className="btnCap4" onClick={() => openModal("/assets/ImgTecnicas/Potenciales/Visual/Cam10-20.jpg")}></button> 

                        {currentImageIndex === 0 && (
                            <button className="btnCapo" onClick={() => {
                        ...
                        {currentImageIndex === 0 && (
                            <button className="btnCapo2" onClick={() => {
                        ...
                        {currentImageIndex === 0 && (
                            <button className="btnCapo3" onClick={() => {
                        ...
                        {currentImageIndex === 0 && (
                            <button className="btnCapo4" onClick={() => {
