...
const AddMagnusH = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_92.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Prono \n\nPuntos de referencia palpables: Epicóndilo medial (tubérculo aductor)' +
                        '\n\nPunto de entrada exacto: 3–4 cm proximal al epicóndilo medial, 1–2 cm posterior \n\nOrientación y profundidad estimada de aguja: Perpendicular; 3–4 cm' + 
                        '\n\nPrecauciones: N. safeno superficial; vasos geniculares \n\nManiobra de activación y/o nota ecográfica: Extensión/aducción; (US recomendable)', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>ADDUCTOR MAGNUS (PARS HAMSTRING)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Aductor mayor (porción isquiotibial)</strong><strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tubérculo aductor (fémur)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de cadera / Aducción<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1,800–2,200<strong></strong>
                        </div>
