...
const MedianoMs = () => {
    ...
    return (
        ...
        <div>
            {/* Primera Imagen */}
                {currentImageIndex === 0 && <button className="btn1" onClick={() => handleButtonClick('Ligeramente distal a articulación metacarpofalángica, evitando colocar electrodo sobre el pliegue cutáneo.', {  top: '12%', left: '32%' })}>A</button>}
                {currentImageIndex === 0 && <button className="btn2" onClick={() => handleButtonClick('Dorso de la mano.', { top: '12%', left: '32%'})}>T</button>}
                {currentImageIndex === 0 && <button className="btn3" onClick={() => handleButtonClick('3-4 cm del electrodo de registo, discretamente distal a articulación interfalángica distal.', { top: '12%', left: '32%'})}>R</button>}
                {currentImageIndex === 0 && <button className="btn4" onClick={() => handleButtonClick('Muñeca: 14 cm distal al electrodo de registro, entre los tendones palmar mayor y palmar menor.', { top: '12%', left: '32%'})}>E</button>}
            {/* Segunda Imagen */}
            ...
            {/* Cuarta Imagen */}
                ...
                {currentImageIndex === 3 && <button className="btn17" onClick={() => handleButtonClick('Texto desde el botón 2', { top: '30%', left: '30%' })}></button>}
