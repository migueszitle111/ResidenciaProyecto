            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Arteria y vena braquial en canal medial; nervio mediano más distal \n\nManiobra de activación y/o nota ecográfica: Flexión del codo contra resistencia; (US recomendada para identificar paquete vasculonervioso medial)', { top: "8%", left: "23%" });
