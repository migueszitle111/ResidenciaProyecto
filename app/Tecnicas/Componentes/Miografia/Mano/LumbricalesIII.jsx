...
const LumbricalesIII = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_04.png", // segunda imagen encima
        ]
    },
];
        ...
        <div  className=" py-20 bg-white gallery-container">
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    ...
                    '\n\nPrecauciones: Nervios digitales ulnares; arco palmar superficial \n\nManiobra de activación y/o nota ecográfica: Flexión MCP dedos 4–5; (US útil para delimitar fibras)', { top: "5%", left: "24.4%"});
                        ...
                        <div className="info-box info-box-19">
                            <strong>LUMBRICALES MANUS (III–IV)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Lumbricales de la mano (3.º–4.º)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. ulnar (C8–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tendones FDP ulnar (dedos 4–5)<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Expansiones dorsales 4–5<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión MCP y extensión IP dedos 4–5/Control fino pinza<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈25,000 cada uno<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈60–90<strong></strong>
                        </div>
