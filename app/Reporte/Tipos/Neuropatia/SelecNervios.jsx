...
export function checkDivs(copyConclusions) {
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '21.1%', left: '60.25%', borderRadius: 100, }}
          className={`dont-print-Nervius`} ><NerviusButton value='car' title='TERCIO PROXIMAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '22.6%', left: '61.9%', borderRadius: '50%', }}
          className={`dont-print-Nervius`} ><NerviusButton value='car' title='TERCIO MEDIAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '25.8%', left: '63.8%', borderRadius: 100, }}
          className={`dont-print-Nervius`}  ><NerviusButton value='car' title='TERCIO DISTAL DE BRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '27.2%', left: '64.5%', borderRadius: 100, }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='LIGAMENTO STRUTHERS,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '28.6%', left: '65.2%', borderRadius: '50%' }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='CODO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '30.2%', left: '65.8%', borderRadius: '50%' }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO PROXIMAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '33.1%', left: '67.1%', borderRadius: '50%', }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO MEDIAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '35.3%', left: '67.9%', borderRadius: '50%', }}
          className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO DISTAL DE ANTEBRAZO,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '38.3%', left: '69.3%', }}
          className={`dont-print-Nervius`} ><NerviusButton value='car' title='TERCIO DISTAL DE ANTEBRAZO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '37.8%', left: '70.55%', }}
          className={`dont-print-Nervius`} ><NerviusButton value='car' title='TERCIO DISTAL DE ANTEBRAZO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '38.5%', left: '71.1%', }}
          className={`dont-print-Nervius`} > <NerviusButton value='car' title='CARPO,' displayText=' ' /></div>


        <div style={{ position: 'absolute', top: '39.2%', left: '71.9%', }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='CARPO,' displayText=' ' /> </div>
        <div style={{ position: 'absolute', top: '39.8%', left: '72.9%', }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='CARPO,' displayText=' ' /> </div>
        <div style={{ position: 'absolute', top: '40.4%', left: '73.9%', }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='PALMA,' displayText=' ' /> </div>
        <div style={{ position: 'absolute', top: '40.9%', left: '74.9%', }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='PALMA,' displayText=' ' /> </div>
        ...
        <div style={{ position: 'absolute', top: '41.9%', left: '72.1%', }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='DEDOS II-III,' displayText=' ' /> </div>
        ...
        <div style={{
          position: 'absolute', top: '43.4%', left: '69.7%',
        }}
          className={`dont-print-Nervius`}> <NerviusButton value='car' title='DEDOS II-III,' displayText=' ' /> </div>
    ...
    return (
      <>
        <div style={{ position: 'absolute', top: '14.5%', left: '51.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TRIANGULO POSTERIOR DEL CUELLO,' displayText=' ' /></div>
        <div style={{ position: 'absolute', top: '14.0%', left: '50.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='FORAMEN YUGULAR,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '14.0%', left: '48.4%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='CEFORAMEN YUGULAR,' displayText=' ' /></div>
    ...
    return (
      <>
        ...
        <div style={{ position: 'absolute', top: '19.1%', left: '60.2%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='ESPACIO CUANDRANGULAR,' displayText=' ' /></div>
        ...
        <div style={{ position: 'absolute', top: '19.0%', left: '62.5%', borderRadius: 100, }}
          className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='SU DIVICION TERMINAL,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('MUSCULOCUTÁNEO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('MUSCULOCUTÁNEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.0%', left: '60.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='INFRACLAVICULAR,' displayText=' ' /></div>
      <div style={{ position: 'absolute', top: '20.7%', left: '61.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='HOMBRO/AXILA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '25.5%', left: '65.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO DISTAL DEL BRAZO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '30.2%', left: '67.8%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO PROXIMAL DEL ANTEBRAZO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '32.6%', left: '68.6%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO MEDIO DEL ANTEBRAZO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('RADIAL DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('RADIAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '18.9%', left: '37.5%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='AXILA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '29.9%', left: '31.3%', borderRadius: '50%', }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO PROXIMAL DEL ANTEBRAZO, RAMA INTEROSEA POSTERIOR,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '30.7%', left: '32.2%', borderRadius: 100, }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='TERCIO PROXIMAL DEL ANTEBRAZO, RAMA RADIAL SUPERFICIA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '32.3%', left: '30.3%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TERCIO PROXIMAL DEL ANTEBRAZO, RAMA INTEROSEA POSTERIOR,' displayText=' ' /></div>
      <div style={{ position: 'absolute', top: '33.0%', left: '30.0%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TERCIO MEDIO DEL ANTEBRAZO, RAMA INTEROSEA POSTERIOR,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '36.1%', left: '28.5%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TERCIO DISTAL DEL ANTEBRAZO, RAMA INTEROSEA POSTERIOR,' displayText=' ' /></div>

      <div style={{ position: 'absolute', top: '32.3%', left: '32.3%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TERCIO MEDIO DEL ANTEBRAZO, RAMA RADIAL SUPERFICIA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '35.5%', left: '32.0%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`}><NerviusButton value='car' title='TERCIO DISTAL DEL ANTEBRAZO, RAMA RADIAL SUPERFICIA,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('SUPRAESCAPULAR IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('SUPRAESCAPULAR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '16.2%', left: '55.2%', borderRadius: 100, }}
        className={`dont-print-Nervius`}><NerviusButton value='car' title='LIGAMENTO TRASVERSO, RAMA SUPRAESPINOSO,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '17.8%', left: '56.7%', borderRadius: 100, }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='FOSA ESPINOGLENOIDEA, RAMA INFRAESPINOSO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('ULNAR DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('ULNAR BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.8%', left: '38.8%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DEL BARZO,' displayText=' ' /></div>

      <div style={{ position: 'absolute', top: '21.5%', left: '38.4%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='TERCIO PROXIMAL DEL BRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '23.6%', left: '37.1%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='TERCIO MEDIAL DEL BRAZO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '28.3%', left: '35.0%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='CODO/CANAL CUBITAL,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '37.1%', left: '31.7%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='TERCIO DISTAL DEL ANTEBRAZO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '37.9%', left: '31.2%', borderRadius: '50%', }}
        className={`dont-print-Nervius`} > <NerviusButton value='car' title='CARPO/CANAL DE GUYON,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('ULNAR IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('ULNAR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '20.8%', left: '59.9%', borderRadius: '50%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DEL BRAZO,' displayText=' ' /></div>
  ...
  if (copyConclusions.includes('FRÉNICO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FRÉNICO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '18.6%', left: '52.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TORAX,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('FRÉNICO DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FRÉNICO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('TORACODORSAL IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TORACODORSAL BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '19.5%', left: '55.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='PECTORAL,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('TORACODORSAL DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TORACODORSAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('TORÁCICO LARGO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TORÁCICO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) { //FALTA VERIFICAR
    return (<>
  ...
  if (copyConclusions.includes('TORÁCICO LARGO DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TORÁCICO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) { //FALTA
    return (<>
  ...
  if (copyConclusions.includes('CIATICO DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('CIATICO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '38.0%', left: '43.0%', }}
        className={`.dont-print-Nerviusgrande`}  > <NerviusButton value='car' title='EMERGENCIA PIRAMIDAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '41.2%', left: '42.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO TERCIO PROXIMAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '45.1%', left: '41.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO TERCIO MEDIO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '48.3%', left: '42.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO TERCIO DISTAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '54.0%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '57.8%', left: '39.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.0%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '58.6%', left: '39.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.6%', left: '40.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.8%', left: '42.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '59.3%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.3%', left: '39.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.3%', left: '41.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.5%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '60.0%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.0%', left: '39.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.0%', left: '41.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.2%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '60.7%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.7%', left: '40.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.9%', left: '41.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '61.5%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '61.5%', left: '40.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '61.5%', left: '41.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '62.3%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '62.3%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '62.3%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '63.0%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.0%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.0%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '63.7%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.7%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.7%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.8%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '64.4%', left: '38.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.4%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.4%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.6%', left: '41.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '65.2%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '65.2%', left: '40.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '65.4%', left: '42.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '66.0%', left: '39.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.0%', left: '40.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.2%', left: '42.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '66.8%', left: '39.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.8%', left: '41.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.0%', left: '42.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '67.6%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.6%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.8%', left: '42.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '68.4%', left: '40.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '68.4%', left: '41.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '68.6%', left: '43.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '69.2%', left: '39.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '69.2%', left: '41.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '69.4%', left: '43.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '70.0%', left: '39.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.0%', left: '40.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.2%', left: '43.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '70.8%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.8%', left: '40.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.0%', left: '43.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '71.4%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.6%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.6%', left: '40.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.8%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '71.9%', left: '36.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.2%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.4%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.4%', left: '40.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.6%', left: '42.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '72.6%', left: '35.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.7%', left: '36.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.0%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.2%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.2%', left: '40.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '73.5%', left: '36.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.8%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '74.0%', left: '39.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('CIATICO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('CIATICO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '57.8%', left: '59.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.0%', left: '56.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '58.6%', left: '59.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='HUECO POPLIEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.6%', left: '57.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '58.8%', left: '56.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '59.3%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.3%', left: '58.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.3%', left: '57.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '59.5%', left: '56.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '60.0%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.0%', left: '58.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.0%', left: '58.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.2%', left: '56.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '60.7%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.7%', left: '58.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '60.9%', left: '57.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '61.5%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '61.5%', left: '58.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '61.5%', left: '57.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '62.3%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '62.3%', left: '58.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '62.3%', left: '57.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '63.0%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.0%', left: '58.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.0%', left: '57.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '63.7%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.7%', left: '58.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.7%', left: '57.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '63.8%', left: '57.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '64.4%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.4%', left: '58.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.4%', left: '57.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '64.6%', left: '56.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '65.2%', left: '59.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '65.2%', left: '58.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '65.4%', left: '56.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '66.0%', left: '59.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.0%', left: '58.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.2%', left: '56.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '66.8%', left: '58.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '66.8%', left: '58.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.0%', left: '56.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '67.6%', left: '58.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.6%', left: '57.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '67.8%', left: '55.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '68.4%', left: '58.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '68.4%', left: '57.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '68.6%', left: '55.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE LA PIERNA,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '69.2%', left: '58.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '69.2%', left: '57.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '69.4%', left: '55.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '70.0%', left: '59.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.0%', left: '58.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.2%', left: '55.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '70.8%', left: '59.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '70.8%', left: '58.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.0%', left: '55.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TOBILLO,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '71.4%', left: '60.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.6%', left: '59.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.6%', left: '57.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '71.8%', left: '56.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>

      <div style={{ position: 'absolute', top: '71.9%', left: '61.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.2%', left: '60.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.4%', left: '59.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.4%', left: '57.7%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.6%', left: '56.3%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='RETROPIE,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '72.6%', left: '62.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '72.7%', left: '61.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.0%', left: '60.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.2%', left: '58.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>


      <div style={{ position: 'absolute', top: '73.5%', left: '62.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '73.8%', left: '60.5%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='ANTEPIE,' displayText=' ' /> </div>

    </>);
  }
  if (copyConclusions.includes('FEMORAL DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FEMORAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '36.8%', left: '41.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='LIGAMENTO INGUINAL,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '54.1%', left: '45.1%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='SAFENO,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('FEMORAL IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FEMORAL BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('OBTURADOR IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('OBTURADOR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '38.7%', left: '56.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='CANAL OBTURADOR,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '41.0%', left: '56.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MUSLO,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('OBTURADOR DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('OBTURADOR BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('PERONEO DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('PERONEO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      <div style={{ position: 'absolute', top: '50.0%', left: '42.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='BIFURCACION EN HUECO POPLITEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '50.8%', left: '42.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='BIFURCACION EN HUECO POPLITEO,' displayText=' ' /> </div>
      <div style={{ position: 'absolute', top: '51.6%', left: '42.0%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='BIFURCACION EN HUECO POPLITEO,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '54.8%', left: '40.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='CABEZA DE PERONE,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '58.0%', left: '39.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO PROXIMAL DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '60.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO MEDIO DE PIERNA,' displayText=' ' /> </div>
      ...
      <div style={{ position: 'absolute', top: '64.4%', left: '40.2%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TERCIO DISTAL DE PIERNA,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('PERONEO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('PERONEO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('TIBIAL DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TIBIAL BILATERAL CON PREDOMINIODERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '71.7%', left: '37.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='TUNEL DEL TARSO,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('TIBIAL IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('TIBIAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('PUDENDO IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('PUDENDO BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '36.7%', left: '47.6%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='LIG. SACROESPINOSO/CANAL PUDENDO,' displayText=' ' /> </div>

    </>);
  }
  if (copyConclusions.includes('PUDENDO DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('PUDENDO BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
  ...
  if (copyConclusions.includes('FACIAL IZQUIERDO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FACIAL BILATERAL CON PREDOMINIO IZQUIERDO, FOCALIZADA A NIVEL DE')) {
    return (<>
      ...
      <div style={{ position: 'absolute', top: '8.5%', left: '50.4%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='DISTAL A FOSA ESTILOMASTOIDEA,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '9.2%', left: '54.8%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MALAR,' displayText=' ' /></div>
      ...
      <div style={{ position: 'absolute', top: '11.2%', left: '52.9%', }}
        className={`.dont-print-Nerviusgrande`} > <NerviusButton value='car' title='MADICULAR,' displayText=' ' /> </div>
  ...
  if (copyConclusions.includes('FACIAL DERECHO, FOCALIZADA A NIVEL DE') || copyConclusions.includes('FACIAL BILATERAL CON PREDOMINIO DERECHO, FOCALIZADA A NIVEL DE')) {
    return (<>
