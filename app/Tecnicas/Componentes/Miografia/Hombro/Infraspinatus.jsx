...
const Infraspinatus = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_43.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio supraescapular; vasos circunflejos escapulares \n\nManiobra de activación y/o nota ecográfica: Rotación externa contra resistencia; (US opcional para delimitar espesor)', { top: "8%", left: "23%" });
                        ...
                        <div className="info-box info-box-1">
                            <strong>INFRASPINATUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Infraespinoso</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. supraescapular (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Fosa infraespinosa<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tubérculo mayor (carilla media)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Rotación externa del hombro/Estabilización glenohumeral<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Mixto (≈55% tipo I, 45% tipo IIa)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈140,000<strong></strong>
                        </div>
