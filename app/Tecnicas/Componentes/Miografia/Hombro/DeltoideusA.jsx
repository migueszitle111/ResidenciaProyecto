...
const DeltoideusA = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_37.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Punto a mitad de camino entre acromion lateral y tuberosidad deltoidea (cara lateral) \n\nPerpendicular a piel' +
                        '\n\nUS: identificar deltoides sobre cabeza humeral; evitar bursa \n\n≈3–4 cm inferior al acromion lateral' + 
                        '\n\nProyección lateral pura del hombro', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_37.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>DELTOIDEUS (PARS ACROMIALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Deltoides (fibras medias)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. axilar (C5–C6)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Borde lateral del acromion<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tuberosidad deltoidea<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción del hombro (principal 15–90°)<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Mixto (≈50% tipo I, 50% tipo IIa)<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈500,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1,000–2,000<strong></strong>
                        </div>
