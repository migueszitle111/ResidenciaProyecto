...
const PronatorQ = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_05.png", // segunda imagen encima
        ]
    },
];
...
const renderGalleryItem = (item) => (
    ...
    return (
        <div  className=" py-20 bg-white gallery-container">
            ...
            '\n\nPrecauciones: Arteria radial lateral y ulnar medial; nervio interóseo anterior cercano \n\nManiobra de activación y/o nota ecográfica: Pronación distal; (US casi imprescindible por localización profunda y vasos cercanos)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_05.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>PRONATOR QUADRATUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Pronador cuadrado</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. interóseo anterior (C8–T1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ulna distal<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Radio distal<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Pronación distal del antebrazo / Estabilización radioulnar distal<strong></strong>
                        </div>
