...
const MultifidiT = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_100.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('1) IZ: unión lámina-transversa (T6–T9 dominante). \n\n2) Profundidad: 2–3.5 cm.' +
                        '\n\n3) Relación: dorsal a costotransversarias. \n\n4) Variaciones: mayor grosor en T12.' + 
                        '\n\n5) Ventana segura: parasagital profunda. \n\n6) Riesgos: contacto costal por angulación inadecuada. \n\n7) Posición del paciente: Decúbito prono; brazos a los lados; soporte bajo abdomen para relajar lordosis.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_100.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>MULTIFIDI THORACIS ET ROTATORES</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Paraespinales torácicos</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Ramos dorsales torácicos<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Procesos transversos T1–T12<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Espinosas 2–4 niveles superiores<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Estabilidad torácica segmentaria / Rotación controlada<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈60% tipo I, ≈40% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈300,000–500,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1000–1800 UM<strong></strong>
                        </div>
