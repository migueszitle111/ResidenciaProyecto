...
const PeroneusB = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_77.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>PERONEUS BREVIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Peroneo Brevis</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio peroneo superficial<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Tercio distal del peroné<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tuberosidad del quinto metatarsiano<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Eversión / Estabilidad lateral tobillo<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈50% tipo I, 50% tipo II<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈180,000–260,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈280–500 UM<strong></strong>
                        </div>
