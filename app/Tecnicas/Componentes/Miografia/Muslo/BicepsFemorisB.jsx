...
const BicepsFemorisB = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_59.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Nervio ciático; arterias perforantes \n\nManiobra de activación y/o nota ecográfica: Extensión cadera/flexión rodilla; (US recomendable)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_59.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>BICEPS FEMORIS (CAPUT BREVE)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Bíceps femoral (cabeza corta)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio peroneo común (ramo a caput breve), L5–S2<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Línea áspera (labio lateral) y septo intermuscular lateral del fémur<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cabeza del peroné (tendón conjunt)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de cadera / Flexión de rodilla y RE<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈0.9–1.2 millones<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈1,000–1,300<strong></strong>
                        </div>
