...
const VastusL = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_87.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('**1) IZ:** tercio medio lateral. \n\n**2) Profundidad:** 1–2.5 cm.' +
                        '\n\n**3) Relación:** separable superficial al FTS. \n\n**4) Variaciones:** IZ más proximal en mujeres.' + 
                        '\n\n**5) Ventana segura:** plano lateral. \n\n**6) Riesgos:** ramas perforantes laterales. \n\n**7) Posición del paciente:** Decúbito supino, rodilla flexionada 20–30°, rotación interna ligera.', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_87.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>VASTUS LATERALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Vasto lateral</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>Nervio femoral<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Línea áspera lateral, trocánter mayor<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tendón cuadricipital–rótula<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Extensión de rodilla / Estabilización lateral patelar<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>≈47% tipo I, 53% tipo IIa/IIx<strong></strong>
                        </div>
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈1,000,000–1,400,000<strong></strong>
                        </div>
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈400–900 UM<strong></strong>
                        </div>
