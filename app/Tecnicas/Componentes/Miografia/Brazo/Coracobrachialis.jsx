...
const Coracobrachialis = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_42.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>CORACOBRACHIALIS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Coracobraquial</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación:</strong>N. musculocutáneo (C5–C7)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Apófisis coracoides<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Cara medial del húmero (mitad)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Flexión y aducción glenohumeral/Estabilización anterior del hombro<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-8">
                            <strong>Cantidad de fibras: </strong>≈90,000<strong></strong>
                        </div>
...
export default Coracobrachialis;
