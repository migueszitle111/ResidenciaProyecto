...
const TensorF = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_80.png", // segunda imagen encima
        ]
    },
];
            ...
            {!isLandscape && (
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        '\n\nPrecauciones: Ramas cutáneas femorales laterales; vasos circunflejos \n\nManiobra de activación y/o nota ecográfica: Abducción/RI; (US útil)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_80.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-19">
                            <strong>TENSOR FASCIAE LATAE</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Tensor de la fascia lata (TFL)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. glúteo superior (L4–S1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>EIAS/cresta ilíaca anterior<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Tracto iliotibial<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Tensionar tracto IT; abducción/RI / Estabilizar rodilla<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Leve predominio IIa (≈45% I, 50% IIa, 5% IIx)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈500–900<strong></strong>
                        </div>
