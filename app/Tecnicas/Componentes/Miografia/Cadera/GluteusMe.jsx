...
const GluteusMe = () => {
    ...
    const images = [
    {
        ...
        layers: [
            ...
            "/assets/ImgTecnicas/miogImg/ELE_78.png", // segunda imagen encima
        ]
    },
];
                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <button className="btnAntb" onClick={() => {
                                handleButtonClick('Posición del paciente: Decúbito lateral contralateral \n\nPuntos de referencia palpables: Cresta ilíaca; trocánter mayor' +
                        ...
                        '\n\nPrecauciones: N. glúteo superior; vasos glúteos \n\nManiobra de activación y/o nota ecográfica: Abducción contra resistencia; (US recomendable)', { top: "5%", left: "24.4%"});
                                handleImageBoxClick("/assets/ImgTecnicas/miogImg/LupaELE_78.png", { top: "50%", left: "50%" });
                            }}
                        >
                            PUNTO MOTOR
                        </button>
                        ...
                        <div className="info-box info-box-1">
                            <strong>GLUTEUS MEDIUS</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Glúteo medio</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. glúteo superior (L4–S1)<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Ilion entre líneas anterior y posterior<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Trocánter mayor (lateral)<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Abducción-estabilización pélvica / RI-RE según fibras<strong></strong>
                        </div>
                        <div className="info-box info-box-7">
                            <strong>Tipo de fibras: </strong>Predominio tipo I (≈60% I, 35% IIa, 5% IIx)<strong></strong>
                        </div>
                        ...
                        <div className="info-box info-box-9">
                            <strong>Unidades motoras: </strong>≈800–1,400<strong></strong>
                        </div>
