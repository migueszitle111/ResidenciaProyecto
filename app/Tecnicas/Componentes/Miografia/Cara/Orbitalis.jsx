                ...
                {currentImageIndex === 0 && (
                    <>
                        ...
                        <div className="info-box info-box-1">
                            <strong>ORBICULARIS OCULI (PARS ORBITALIS)</strong> <strong></strong>
                        </div>
                        <div className="info-box info-box-2">
                            <strong>Orbicular de los ojos (orbital)</strong><strong></strong>
                        </div>
                        <div className="info-box info-box-3">
                            <strong>Inervación: </strong>N. facial (VII), ramas temporal y cigomática<strong></strong>
                        </div>
                        <div className="info-box info-box-4">
                            <strong> Origen: </strong>Borde orbitario<strong></strong>
                        </div>
                        <div className="info-box info-box-5">
                            <strong>Inserción: </strong>Piel circunferencia orbital<strong></strong>
                        </div>
                        <div className="info-box info-box-6">
                            <strong>Función: </strong>Cierre ocular fuerte / Expresión intensa<strong></strong>
                        </div>
